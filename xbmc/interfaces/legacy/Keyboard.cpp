...
Keyboard::Keyboard(const String& line /* = nullString*/,
                   const String& heading /* = nullString*/,
                   bool hidden /* = false*/)
  : strDefault(line)
  , strHeading(heading)
  , bHidden(hidden)
...
void Keyboard::doModal(int autoclose)
{
  ...
  bConfirmed = CGUIKeyboardFactory::ShowAndGetInput(text, CVariant{strHeading}, true, bHidden,
                                                    autoclose * 1000);
  strText = text;
}
