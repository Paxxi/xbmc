...
public:
...
#endif
  {
    ...
    g_application.GetAppPlayer().RenderCapture(m_captureId, m_width, m_height,
...
// hide these from swig
  ...
  {
    return g_application.GetAppPlayer().RenderCaptureGetPixels(m_captureId, msec, m_buffer,
                                                               m_width * m_height * 4);
  }
#endif
};
