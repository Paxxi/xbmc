...
bool addDirectoryItem(
    int handle, const String& url, const xbmcgui::ListItem* listItem, bool isFolder, int totalItems)
{
  if (listItem == nullptr)
...
void setPluginFanart(
    int handle, const char* image, const char* color1, const char* color2, const char* color3)
{
  if (image)
