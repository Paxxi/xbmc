...
public:
  ...
  select(...);
#else
  int select(const String& heading,
  ...
  browse(...);
#else
  Alternative<String, std::vector<String>> browse(int type,
                                                  const String& heading,
                                                  const String& shares,
                                                  const String& mask = emptyString,
  ...
  browseMultiple(...);
#else
  std::vector<String> browseMultiple(int type,
                                     const String& heading,
                                     const String& shares,
                                     const String& mask = emptyString,
                                     bool useThumbs = false,
  ...
  notification(...);
#else
  void notification(const String& heading,
...
public:
  ...
  create(...);
#else
  void create(const String& heading,
              const String& line1 = emptyString,
              const String& line2 = emptyString,
              const String& line3 = emptyString);
#endif
