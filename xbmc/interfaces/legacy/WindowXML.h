...
public:
  WindowXML(const String& xmlFilename,
  ...
  addItem(...);
#else
  SWIGHIDDENVIRTUAL void addItem(const Alternative<String, const ListItem*>& item,
  ...
  addItems(...);
#else
  SWIGHIDDENVIRTUAL void addItems(
  ...
  SWIGHIDDENVIRTUAL bool IsMediaWindow() const override
  {
    XBMC_TRACE;
    return m_isMedia;
  };
...
{
public:
  WindowXMLDialog(const String& xmlFilename,
                  const String& scriptPath,
                  const String& defaultSkin = "Default",
                  const String& defaultRes = "720p");
  ...
  SWIGHIDDENVIRTUAL inline void show() override
  {
    XBMC_TRACE;
    WindowDialogMixin::show();
  }
  SWIGHIDDENVIRTUAL inline void close() override
  {
    XBMC_TRACE;
