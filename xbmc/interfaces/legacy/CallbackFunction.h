...
protected:
  ...
  explicit Callback(AddonClass* _object)
...
template<typename M = cb_null_type,
         typename T1 = cb_null_type,
         typename T2 = cb_null_type,
         typename T3 = cb_null_type,
         typename T4 = cb_null_type,
         typename Extraneous = cb_null_type>
...
/**
   ...
   */
template<class M, typename P1>
class CallbackFunction<M,
                       AddonClass::Ref<P1>,
                       cb_null_type,
                       cb_null_type,
                       cb_null_type,
                       cb_null_type> : public Callback
{
public:
  typedef void (M::*MemberFunction)(P1*);
...
class CallbackFunction<M, P1, P2, cb_null_type, cb_null_type, cb_null_type> : public Callback
{
public:
...
/**
   ...
   */
template<class M, typename P1, typename P2, typename P3>
class CallbackFunction<M, P1, P2, P3, cb_null_type, cb_null_type> : public Callback
{
public:
