...
public:
  inline explicit DelayedCallGuard(LanguageHook* languageHook_)
    : languageHook(languageHook_)
  {
    if (languageHook)
...
{
public:
  inline explicit SetLanguageHookGuard(LanguageHook* languageHook)
  {
    LanguageHook::SetLanguageHook(languageHook);
  }
