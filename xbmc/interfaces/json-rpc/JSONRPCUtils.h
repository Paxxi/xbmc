...
namespace JSONRPC
{
   ...
   */
  typedef JSONRPC_STATUS (*MethodCall) (const std::string &method, ITransportLayer *transport, IClient *client, const KODI::UTILS::CVariant& parameterObject, KODI::UTILS::CVariant &result);
