...
private:
  ...
  int m_offset;
  int m_cacheItems;
  KODI::UTILS::CStopWatch m_scrollTimer;
  KODI::UTILS::CStopWatch m_lastScrollStartTimer;
  KODI::UTILS::CStopWatch m_pageChangeTimer;

  // letter match searching
  KODI::UTILS::CStopWatch m_matchTimer;
  std::string m_match;
