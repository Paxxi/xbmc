                                        ...
                                        bool insideContainer)
{
  ...
  case CGUIControl::GUICONTROL_LABEL:
  {
    const GUIINFO::CGUIInfoLabel& content =
        (infoLabels.size()) ? infoLabels[0] : GUIINFO::CGUIInfoLabel("");
    if (insideContainer)
  ...
  {
    control = new CGUIFadeLabelControl(parentID, id, posX, posY, width, height, labelInfo,
                                       scrollOut, timeToPauseAtEnd, resetOnLabelChange, randomized);
  ...
  {
    control = new CGUISliderControl(parentID, id, posX, posY, width, height, textureBar, textureNib,
                                    textureNibFocus, SLIDER_CONTROL_TYPE_PERCENTAGE, orientation);
  ...
  {
    control = new CGUISettingsSliderControl(parentID, id, posX, posY, width, height, sliderWidth,
                                            sliderHeight, textureFocus, textureNoFocus, textureBar,
                                            textureNib, textureNibFocus, labelInfo,
  ...
  case CGUIControl::GUICONTAINER_LIST:
  {
    ...
    control = new CGUIListContainer(parentID, id, posX, posY, width, height, orientation, scroller,
                                    preloadItems);
  ...
  case CGUIControl::GUICONTAINER_PANEL:
  {
    ...
    control = new CGUIPanelContainer(parentID, id, posX, posY, width, height, orientation, scroller,
                                     preloadItems);
  ...
  {
    control =
        new CGUIMoverControl(parentID, id, posX, posY, width, height, textureFocus, textureNoFocus);
  }
  break;
  ...
  {
    control = new CGUISpinControlEx(parentID, id, posX, posY, width, height, spinWidth, spinHeight,
                                    labelInfo, textureFocus, textureNoFocus, textureUp, textureDown,
                                    textureUpFocus, textureDownFocus, textureUpDisabled,
                                    textureDownDisabled, labelInfo, iType);
