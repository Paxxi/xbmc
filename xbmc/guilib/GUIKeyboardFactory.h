...
class CGUIKeyboardFactory
{
  ...
  public:
    ...
    static bool ShowAndGetInput(std::string& aTextString, const KODI::UTILS::CVariant &heading, bool allowEmptyResult, bool hiddenInput = false, unsigned int autoCloseMs = 0);
    static bool ShowAndGetNewPassword(std::string& strNewPassword, unsigned int autoCloseMs = 0);
    static bool ShowAndGetNewPassword(std::string& newPassword, const KODI::UTILS::CVariant &heading, bool allowEmpty, unsigned int autoCloseMs = 0);
    static bool ShowAndVerifyNewPassword(std::string& strNewPassword, unsigned int autoCloseMs = 0);
    static bool ShowAndVerifyNewPassword(std::string& newPassword, const KODI::UTILS::CVariant &heading, bool allowEmpty, unsigned int autoCloseMs = 0);
