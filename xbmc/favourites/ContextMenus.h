...
{
public:
  explicit CFavouriteContextMenuAction(uint32_t label)
...
public:
  CRemoveFavourite()
    : CFavouriteContextMenuAction(15015)
  {
  } // Remove
protected:
...
public:
  CRenameFavourite()
    : CFavouriteContextMenuAction(118)
  {
  } // Rename
protected:
  bool DoExecute(CFileItemList& items, const CFileItemPtr& item) const override;
...
{
public:
  CChooseThumbnailForFavourite()
    : CFavouriteContextMenuAction(20019)
  {
  } // Choose thumbnail
protected:
  bool DoExecute(CFileItemList& items, const CFileItemPtr& item) const override;
