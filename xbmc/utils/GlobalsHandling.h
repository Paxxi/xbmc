...
#define XBMC_GLOBAL_REF(classname,g_variable) \
  static std::shared_ptr<classname> g_variable##Ref(KODI::UTILS::GlobalsSingleton<classname>::getInstance())
 ...
 */
#define XBMC_GLOBAL_USE(classname) (*(KODI::UTILS::GlobalsSingleton<classname>::getQuick()))
