...
TEST_F(TestSystemInfo, GetKernelVersionFull)
{
  ...
  EXPECT_EQ(nullptr, g_sysinfo.GetKernelVersionFull().find_first_of("0123456789")) << "'GetKernelVersionFull()' must not return version not starting from digit";
}
...
TEST_F(TestSystemInfo, GetKernelVersion)
{
  ...
  EXPECT_EQ(nullptr, g_sysinfo.GetKernelVersion().find_first_of("0123456789")) << "'GetKernelVersion()' must not return version not starting from digit";
...
TEST_F(TestSystemInfo, GetOsVersion)
{
  ...
  EXPECT_EQ(nullptr, g_sysinfo.GetOsVersion().find_first_of("0123456789")) << "'GetOsVersion()' must not return version not starting from digit";
