...
private:
  ...
  void FillRectMosaicSeparated(UTILS::Color* lfb,
                               int xres,
                               int x,
                               int y,
                               int w,
                               ...
                               UTILS::Color bgcolor,
                               int set);
  void FillTrapez(UTILS::Color* lfb,
                  int xres,
                  int x0,
                  int y0,
                  int l0,
  ...
  void DrawShape(UTILS::Color* lfb,
                 int xres,
                 int x,
                 int y,
                 int shapenumber,
  ...
  void Eval_NumberedObject(int p,
                           int s,
                           int packet,
                           int triplet,
                           int high,
  ...
  static FT_Error MyFaceRequester(FTC_FaceID face_id,
                                  FT_Library library,
  ...
  std::shared_ptr<TextCacheStruct_t>
      m_txtCache; /* Text cache generated by the VideoPlayer if Teletext present */
