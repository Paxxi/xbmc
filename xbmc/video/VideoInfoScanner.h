...
namespace VIDEO
{
  ...
  protected:
     ...
     */
    bool GetEpisodeAndSeasonFromRegExp(KODI::UTILS::CRegExp &reg, EPISODE &episodeInfo, int defaultSeason);
     ...
     */
    bool GetAirDateFromRegExp(KODI::UTILS::CRegExp &reg, EPISODE &episodeInfo);
