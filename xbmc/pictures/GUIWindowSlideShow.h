...
public:
  ...
  void RunSlideShow(const std::string &strPath, bool bRecursive = false,
                    ...
                    KODI::PRESENTATION::SortBy method = KODI::PRESENTATION::SortByLabel,
                    KODI::PRESENTATION::SortOrder order = KODI::PRESENTATION::SortOrderAscending,
                    KODI::PRESENTATION::SortAttribute sortAttributes = KODI::PRESENTATION::SortAttributeNone,
