...
CJNIXBMCNsdManagerDiscoveryListener::CJNIXBMCNsdManagerDiscoveryListener(
    const CJNIXBMCNsdManagerDiscoveryListener& other)
  : CJNIBase(other)
{
  add_instance(m_object, this);
}
  ...
  if (cClass)
  {
    JNINativeMethod methods[] = {
        {"_onDiscoveryStarted", "(Ljava/lang/String;)V",
         (void*)&CJNIXBMCNsdManagerDiscoveryListener::_onDiscoveryStarted},
        {"_onDiscoveryStopped", "(Ljava/lang/String;)V",
         (void*)&CJNIXBMCNsdManagerDiscoveryListener::_onDiscoveryStopped},
        {"_onServiceFound", "(Landroid/net/nsd/NsdServiceInfo;)V",
         (void*)&CJNIXBMCNsdManagerDiscoveryListener::_onServiceFound},
        {"_onServiceLost", "(Landroid/net/nsd/NsdServiceInfo;)V",
         (void*)&CJNIXBMCNsdManagerDiscoveryListener::_onServiceLost},
        {"_onStartDiscoveryFailed", "(Ljava/lang/String;I)V",
         (void*)&CJNIXBMCNsdManagerDiscoveryListener::_onStartDiscoveryFailed},
        {"_onStopDiscoveryFailed", "(Ljava/lang/String;I)V",
         (void*)&CJNIXBMCNsdManagerDiscoveryListener::_onStopDiscoveryFailed},
    };
                                                              ...
                                                              jstring serviceType)
{
  ...
  CLog::Log(LOGDEBUG, "CJNIXBMCNsdManagerDiscoveryListener::onDiscoveryStarted type: %s",
            st.c_str());
}
                                                              ...
                                                              jstring serviceType)
{
  ...
  std::string st = jcast<std::string>(jhstring(serviceType));
  CLog::Log(LOGDEBUG, "CJNIXBMCNsdManagerDiscoveryListener::onDiscoveryStopped type: %s",
            st.c_str());
}
