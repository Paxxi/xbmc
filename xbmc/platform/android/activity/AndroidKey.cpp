...
#if 1
    CXBMCApp::android_printf(
        "CAndroidKey: key up (dev:%d; src:%d; code: %d; repeat: %d; flags: 0x%0X; alt: %s; shift: "
        "%s; sym: %s)",
        deviceId, source, keycode, repeat, flags, (state & AMETA_ALT_ON) ? "yes" : "no",
        (state & AMETA_SHIFT_ON) ? "yes" : "no", (state & AMETA_SYM_ON) ? "yes" : "no");
#endif
...
#if 1
    CXBMCApp::android_printf(
        "CAndroidKey: key multiple (dev:%d; src:%d; code: %d; repeat: %d; flags: 0x%0X; alt: %s; "
        "shift: %s; sym: %s)",
        deviceId, source, keycode, repeat, flags, (state & AMETA_ALT_ON) ? "yes" : "no",
        (state & AMETA_SHIFT_ON) ? "yes" : "no", (state & AMETA_SYM_ON) ? "yes" : "no");
#endif
...
#if 1
    CXBMCApp::android_printf(
        "CAndroidKey: unknown key (dev:%d; src:%d; code: %d; repeat: %d; flags: 0x%0X; alt: %s; "
        "shift: %s; sym: %s)",
        deviceId, source, keycode, repeat, flags, (state & AMETA_ALT_ON) ? "yes" : "no",
        (state & AMETA_SHIFT_ON) ? "yes" : "no", (state & AMETA_SYM_ON) ? "yes" : "no");
#endif
...
void CAndroidKey::XBMC_Key(
    uint8_t code, uint16_t key, uint16_t modifiers, uint16_t unicode, bool up)
{
