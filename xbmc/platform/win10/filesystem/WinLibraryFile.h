...
private:
  ...
  static bool IsInList(const CURL& url,
                       const winrt::Windows::Storage::AccessCache::IStorageItemAccessList& list);
  static winrt::hstring GetTokenFromList(
      const CURL& url, const winrt::Windows::Storage::AccessCache::IStorageItemAccessList& list);
