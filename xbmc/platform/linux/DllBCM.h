...
public:
  ...
  virtual int32_t graphics_get_display_size(const uint16_t display_number,
                                            uint32_t* width,
                                            uint32_t* height) = 0;
  ...
  virtual int vc_tv_hdmi_power_on_best(uint32_t width,
                                       uint32_t height,
                                       uint32_t frame_rate,
                                       HDMI_INTERLACED_T scan_mode,
                                       EDID_MODE_MATCH_FLAG_T match_flags) = 0;
  virtual int vc_tv_hdmi_power_on_best_3d(uint32_t width,
                                          uint32_t height,
                                          uint32_t frame_rate,
                                          HDMI_INTERLACED_T scan_mode,
                                          EDID_MODE_MATCH_FLAG_T match_flags) = 0;

  virtual int vc_tv_hdmi_get_supported_modes_new(HDMI_RES_GROUP_T group,
  ...
  virtual int vc_tv_hdmi_power_on_explicit_new(HDMI_MODE_T mode,
  ...
  virtual DISPMANX_ELEMENT_HANDLE_T vc_dispmanx_element_add(DISPMANX_UPDATE_HANDLE_T update,
  ...
  virtual int vc_dispmanx_update_submit(DISPMANX_UPDATE_HANDLE_T update,
                                        DISPMANX_CALLBACK_FUNC_T cb_func,
                                        void* cb_arg) = 0;

  virtual int vc_dispmanx_element_remove(DISPMANX_UPDATE_HANDLE_T update,
  ...
  virtual int vc_dispmanx_display_get_info(DISPMANX_DISPLAY_HANDLE_T display,
                                           DISPMANX_MODEINFO_T* pinfo) = 0;
  virtual int vc_dispmanx_display_set_background(DISPMANX_UPDATE_HANDLE_T update,
                                                 DISPMANX_DISPLAY_HANDLE_T display,
                                                 uint8_t red,
                                                 uint8_t green,
                                                 uint8_t blue) = 0;
  virtual int vc_tv_hdmi_audio_supported(uint32_t audio_format,
...
{
public:
  virtual void bcm_host_init() { return ::bcm_host_init(); };
  virtual void bcm_host_deinit() { return ::bcm_host_deinit(); };
  virtual int32_t graphics_get_display_size(const uint16_t display_number,
                                            uint32_t* width,
                                            uint32_t* height)
  {
  ...
  virtual int vc_tv_power_off() { return ::vc_tv_power_off(); }
  virtual int vc_tv_sdtv_power_on(SDTV_MODE_T mode, SDTV_OPTIONS_T* options)
  {
    return ::vc_tv_sdtv_power_on(mode, options);
  }
  virtual int vc_tv_hdmi_power_on_preferred() { return ::vc_tv_hdmi_power_on_preferred(); }
  virtual int vc_tv_hdmi_power_on_best(uint32_t width,
                                       uint32_t height,
                                       uint32_t frame_rate,
                                       HDMI_INTERLACED_T scan_mode,
  ...
  virtual int vc_tv_show_info(uint32_t show) { return ::vc_tv_show_info(show); };
  ...
  {
    return ::vc_dispmanx_element_add(update, display, layer, dest_rect, src, src_rect, protection,
  ...
  virtual int vc_dispmanx_element_change_attributes(DISPMANX_UPDATE_HANDLE_T update,
                                                    ...
                                                    DISPMANX_TRANSFORM_T transform)
  {
    return ::vc_dispmanx_element_change_attributes(update, element, change_flags, layer, opacity,
                                                   dest_rect, src_rect, mask, transform);
  };
...
class DllBcmHost : public DllDynamic, DllBcmHostInterface
{
  ...
  DEFINE_METHOD3(int32_t,
                 graphics_get_display_size,
                 (const uint16_t p1, uint32_t* p2, uint32_t* p3))
  DEFINE_METHOD5(
      int,
      vc_tv_hdmi_power_on_best,
      (uint32_t p1, uint32_t p2, uint32_t p3, HDMI_INTERLACED_T p4, EDID_MODE_MATCH_FLAG_T p5))
  DEFINE_METHOD5(
      int,
  ...
  DEFINE_METHOD5(int,
                 ...
                 (HDMI_RES_GROUP_T p1,
                  TV_SUPPORTED_MODE_NEW_T* p2,
                  uint32_t p3,
                  HDMI_RES_GROUP_T* p4,
                  uint32_t* p5))
  DEFINE_METHOD3(int,
                 vc_tv_hdmi_power_on_explicit_new,
                 (HDMI_MODE_T p1, HDMI_RES_GROUP_T p2, uint32_t p3))
  ...
  DEFINE_METHOD10(DISPMANX_ELEMENT_HANDLE_T,
                  vc_dispmanx_element_add,
                  (DISPMANX_UPDATE_HANDLE_T p1,
                   DISPMANX_DISPLAY_HANDLE_T p2,
                   int32_t p3,
                   const VC_RECT_T* p4,
                   DISPMANX_RESOURCE_HANDLE_T p5,
                   const VC_RECT_T* p6,
                   DISPMANX_PROTECTION_T p7,
                   VC_DISPMANX_ALPHA_T* p8,
                   DISPMANX_CLAMP_T* p9,
                   DISPMANX_TRANSFORM_T p10))
  DEFINE_METHOD1(int, vc_dispmanx_update_submit_sync, (DISPMANX_UPDATE_HANDLE_T p1))
  DEFINE_METHOD3(int,
                 vc_dispmanx_update_submit,
                 (DISPMANX_UPDATE_HANDLE_T p1, DISPMANX_CALLBACK_FUNC_T p2, void* p3))
  DEFINE_METHOD2(int,
                 vc_dispmanx_element_remove,
                 (DISPMANX_UPDATE_HANDLE_T p1, DISPMANX_ELEMENT_HANDLE_T p2))
  DEFINE_METHOD9(int,
  ...
  DEFINE_METHOD2(int,
                 ...
                 (DISPMANX_DISPLAY_HANDLE_T p1, DISPMANX_MODEINFO_T* p2))
  DEFINE_METHOD5(int,
  ...
  DEFINE_METHOD4(int,
                 ...
                 (uint32_t p1, uint32_t p2, EDID_AudioSampleRate p3, uint32_t p4))
...
public:
  virtual bool Load() { return DllDynamic::Load(); }
};
#endif
