...
void WINAPI DXGetErrorDescriptionW(_In_ HRESULT hr, _Out_cap_(count) WCHAR* desc, _In_ size_t count)
{
  ...
  *desc = 0;
  ...
  switch (hr)
  {
    ...
    CHK_ERR(DDERR_NOALPHAHW, "Operation could not be carried out because there is no alpha "
                             "acceleration hardware present or available.")
    CHK_ERR(DDERR_NOSTEREOHARDWARE, "Operation could not be carried out because there is no stereo "
                                    "hardware present or available.")
    CHK_ERR(DDERR_NOSURFACELEFT, "Operation could not be carried out because there is no hardware "
                                 "present which supports stereo surfaces")
    CHK_ERR(DDERR_NOCLIPLIST, "no clip list available")
    CHK_ERR(DDERR_NOCOLORCONVHW, "Operation could not be carried out because there is no color "
    ...
    CHK_ERR(DDERR_NOCOLORKEYHW, "Operation could not be carried out because there is no hardware "
    ...
    CHK_ERR(DDERR_NOEXCLUSIVEMODE, "Operation requires the application to have exclusive mode but "
    ...
    CHK_ERR(DDERR_NOOVERLAYHW, "Operation could not be carried out because there is no overlay "
                               "hardware present or available.")
    CHK_ERR(DDERR_OVERLAPPINGRECTS,
            "Operation could not be carried out because the source and destination rectangles are "
            "on the same surface and overlap each other.")
    CHK_ERR(DDERR_NORASTEROPHW, "Operation could not be carried out because there is no "
                                "appropriate raster op hardware present or available.")
    CHK_ERR(DDERR_NOROTATIONHW, "Operation could not be carried out because there is no rotation "
                                "hardware present or available.")
    CHK_ERR(
        DDERR_NOSTRETCHHW,
        "Operation could not be carried out because there is no hardware support for stretching")
    CHK_ERR(DDERR_NOT4BITCOLOR, "DirectDrawSurface is not in 4 bit color palette and the requested "
                                "operation requires 4 bit color palette.")
    CHK_ERR(DDERR_NOT4BITCOLORINDEX, "DirectDrawSurface is not in 4 bit color index palette and "
                                     "the requested operation requires 4 bit color index palette.")
    CHK_ERR(DDERR_NOT8BITCOLOR, "DirectDraw Surface is not in 8 bit color mode and the requested "
                                "operation requires 8 bit color.")
    CHK_ERR(DDERR_NOTEXTUREHW, "Operation could not be carried out because there is no texture "
                               "mapping hardware present or available.")
    CHK_ERR(DDERR_NOVSYNCHW, "Operation could not be carried out because there is no hardware "
                             "support for vertical blank synchronized operations.")
    CHK_ERR(DDERR_NOZBUFFERHW, "Operation could not be carried out because there is no hardware "
                               "support for zbuffer blting.")
    CHK_ERR(DDERR_NOZOVERLAYHW, "Overlay surfaces could not be z layered based on their BltOrder "
    ...
    CHK_ERR(DDERR_PALETTEBUSY, "Access to this palette is being refused because the palette is "
    ...
    CHK_ERR(DDERR_SURFACEBUSY, "Access to this surface is being refused because the surface is "
                               "already locked by another thread.")
    CHK_ERR(DDERR_CANTLOCKSURFACE,
            "Access to this surface is being refused because no driver exists which can supply a "
            "pointer to the surface. This is most likely to happen when attempting to lock the "
            "primary surface when no DCI provider is present. Will also happen on attempts to lock "
            "an optimized surface.")
    CHK_ERR(DDERR_SURFACEISOBSCURED, "Access to Surface refused because Surface is obscured.")
    CHK_ERR(DDERR_SURFACELOST,
            "Access to this surface is being refused because the surface is gone. The "
    ...
    CHK_ERR(DDERR_NODIRECTDRAWHW, "A hardware only DirectDraw object creation was attempted but "
                                  "the driver did not support any hardware.")
    ...
    CHK_ERR(DDERR_CLIPPERISUSINGHWND, "an attempt was made to set a clip list for a clipper object "
                                      "that is already monitoring an hwnd.")
    CHK_ERR(DDERR_NOCLIPPERATTACHED, "No clipper object attached to surface object")
    CHK_ERR(DDERR_NOHWND, "Clipper notification requires an HWND or no HWND has previously been "
                          "set as the CooperativeLevel HWND.")
    CHK_ERR(DDERR_HWNDSUBCLASSED, "HWND used by DirectDraw CooperativeLevel has been subclassed, "
                                  "this prevents DirectDraw from restoring state.")
    CHK_ERR(DDERR_HWNDALREADYSET, "The CooperativeLevel HWND has already been set. It can not be "
    ...
    CHK_ERR(DDERR_NOOVERLAYDEST,
            "returned when GetOverlayPosition is called on a overlay that UpdateOverlay has never "
            "been called on to establish a destionation.")
    CHK_ERR(DDERR_INVALIDPOSITION, "returned when the position of the overlay on the destionation "
                                   "is no longer legal for that destionation.")
    ...
    CHK_ERR(DDERR_NOTLOCKED, "Surface was not locked.  An attempt to unlock a surface that was not "
    ...
    CHK_ERR(DDERR_NOMIPMAPHW, "Operation could not be carried out because there is no mip-map "
    ...
    CHK_ERR(DDERR_DCALREADYCREATED, "A DC has already been returned for this surface. Only one DC "
                                    "can be retrieved per surface.")
    CHK_ERR(DDERR_NONONLOCALVIDMEM, "An attempt was made to allocate non-local video memory from a "
    ...
    CHK_ERR(DDERR_DEVICEDOESNTOWNSURFACE, "Surfaces created by one direct draw device cannot be "
                                          "used directly by another direct draw device.")
    ...
    CHK_ERR(DIERR_BADDRIVERVER, "The object could not be created due to an incompatible driver "
    ...
    CHK_ERR(
        ...
        "Unable to IDirectInputJoyConfig_Acquire because the user does not have sufficient "
        "privileges to change the joystick configuration. & An invalid media type was specified")
    CHK_ERR(DIERR_DEVICEFULL, "The device is full. & An invalid media subtype was specified.")
    CHK_ERR(DIERR_MOREDATA, "Not all the requested information fit into the buffer. & This object "
                            "can only be created as an aggregated object.")
    CHK_ERR(DIERR_NOTDOWNLOADED,
    ...
    CHK_ERR(DIERR_NOTEXCLUSIVEACQUIRED,
            "The operation cannot be performed unless the device is acquired in DISCL_EXCLUSIVE "
            "mode. & This operation cannot be performed because the filter is active.")
    CHK_ERR(DIERR_INCOMPLETEEFFECT,
            "The effect could not be downloaded because essential information is missing.  For "
            "example, no axes have been associated with the effect, or no type-specific "
            "information has been created. & One of the specified pins supports no media types.")
    CHK_ERR(DIERR_NOTBUFFERED, "Attempted to read buffered device data from a device that is not "
    ...
    CHK_ERR(DIERR_UNPLUGGED,
            "The operation could not be completed because the device is not plugged in. & The "
            "operation cannot be performed because the pins are not connected.")
    CHK_ERR(DIERR_REPORTFULL,
            "SendDeviceData failed because more information was requested to be sent than can be "
            "sent to the device.  Some devices have restrictions on how much data can be sent to "
            "them.  (For example, there might be a limit on the number of buttons that can be "
            "pressed at once.) & No sample buffer allocator is available.")
    CHK_ERR(DIERR_MAPFILEFAIL, "A mapper file function failed because reading or writing the user "
    ...
    CHK_ERR(DIERR_DRIVERFIRST, "Device driver-specific codes. Unless the specific driver has been "
    ...
    CHK_ERR(DIERR_CANCELLED, "The user cancelled the install operation. & The stream already has "
                             "allocated samples and the surface doesn't match the sample format.")
    CHK_ERR(DIERR_BADINF, "The INF file for the selected device could not be found or is invalid "
    ...
    CHK_ERR(DSERR_ALLOCATED, "The call failed because resources (such as a priority level) were "
    ...
    // dxgi.h error codes
    // -------------------------------------------------------------
    CHK_ERR(DXGI_STATUS_OCCLUDED, "The target window or output has been occluded. The application "
    ...
    CHK_ERR(DXGI_ERROR_INVALID_CALL,
            "The application has made an erroneous API call that it had enough information to "
            "avoid. This error is intended to denote that the application should be altered to "
            "avoid the error. Use of the debug version of the DXGI.DLL will provide run-time debug "
            "output with further information.")
    CHK_ERR(DXGI_ERROR_NOT_FOUND,
            "The item requested was not found. For GetPrivateData calls, this means that the "
            "specified GUID had not been previously associated with the object.")
    ...
    CHK_ERR(DXGI_ERROR_NONEXCLUSIVE,
            "The application attempted to perform an operation on an DXGI output that is only "
            "legal after the output has been claimed for exclusive ownership.")
    ...
    CHK_ERR(D2DERR_RECREATE_TARGET,
            "here has been a presentation error that may be recoverable. The caller needs to "
            "recreate, rerender the entire frame, and reattempt present.")
    ...
    CHK_ERR(D2DERR_TEXT_RENDERER_NOT_RELEASED,
            "The application is holding a reference to the IDWriteTextRenderer interface after the "
            "corresponding DrawText or DrawTextLayout call has returned. The IDWriteTextRenderer "
    ...
    CHK_ERR(DWRITE_E_UNEXPECTED, "Indicates an error originating in DirectWrite code, which is not "
    ...
    CHK_ERR(DWRITE_E_FILEACCESS, "A font file exists but could not be opened due to access denied, "
    ...
    CHK_ERR(DXUTERR_NONZEROREFCOUNT, "The device interface has a non-zero reference count, meaning "
                                     "that some objects were not released.")
