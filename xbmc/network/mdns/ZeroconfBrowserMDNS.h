...
private:
  ...
  void addDiscoveredService(DNSServiceRef browser,
                            CZeroconfBrowser::ZeroconfService const& fcr_service);
  /// removes the service from list of found services
  void removeDiscoveredService(DNSServiceRef browser,
                               CZeroconfBrowser::ZeroconfService const& fcr_service);
  ...
  typedef std::map<DNSServiceRef, std::vector<std::pair<ZeroconfService, unsigned int>>>
