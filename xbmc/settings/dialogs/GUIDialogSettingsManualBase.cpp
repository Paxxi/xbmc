...
void CGUIDialogSettingsManualBase::InitializeSettings()
{
  if (GetSettingsManager() != nullptr)
  {
    ...
    m_section =
        std::make_shared<CSettingSection>(GetProperty("xmlfile").asString(), GetSettingsManager());
  }
}
...
SettingGroupPtr CGUIDialogSettingsManualBase::AddGroup(SettingCategoryPtr category,
                                                       int label /* = -1 */,
                                                       int help /* = -1 */,
...
std::shared_ptr<CSettingBool> CGUIDialogSettingsManualBase::AddToggle(SettingGroupPtr group,
                                                                      const std::string& id,
                                                                      int label,
                                                                      SettingLevel level,
                                                                      bool value,
                                                                      ...
                                                                      int help /* = -1 */)
{
  ...
  std::shared_ptr<CSettingBool> setting =
    ...
    int help /* = -1 */)
{
  ...
  std::shared_ptr<CSettingInt> setting =
    ...
    int help /* = -1 */)
{
  ...
  std::shared_ptr<CSettingNumber> setting = std::make_shared<CSettingNumber>(
      id, label, value, minimum, step, maximum, GetSettingsManager());
  if (setting == NULL)
    return NULL;
...
std::shared_ptr<CSettingString> CGUIDialogSettingsManualBase::AddEdit(SettingGroupPtr group,
                                                                      const std::string& id,
                                                                      int label,
                                                                      SettingLevel level,
                                                                      std::string value,
                                                                      ...
                                                                      int help /* = -1 */)
{
  ...
  std::shared_ptr<CSettingString> setting =
      std::make_shared<CSettingString>(id, label, value, GetSettingsManager());
  if (setting == NULL)
    return NULL;
...
std::shared_ptr<CSettingString> CGUIDialogSettingsManualBase::AddIp(SettingGroupPtr group,
                                                                    const std::string& id,
                                                                    int label,
                                                                    SettingLevel level,
                                                                    std::string value,
    ...
    int help /* = -1 */)
{
  ...
  std::shared_ptr<CSettingAction> setting =
      std::make_shared<CSettingAction>(id, label, GetSettingsManager());
  if (setting == NULL)
    return NULL;
    ...
    int help /* = -1 */)
{
  ...
  std::shared_ptr<CSettingString> setting =
      std::make_shared<CSettingString>(id, label, info, GetSettingsManager());
  if (setting == NULL)
    return NULL;
    ...
    int help /* = -1 */)
{
  ...
  std::shared_ptr<CSettingAddon> setting =
      std::make_shared<CSettingAddon>(id, label, value, GetSettingsManager());
  if (setting == NULL)
    return NULL;

  setting->SetControl(GetButtonControl("addon", delayed, heading, hideValue, showInstalledAddons,
                                       showInstallableAddons, showMoreAddons));
    ...
    int help /* = -1 */)
{
  ...
  std::shared_ptr<CSettingPath> setting =
      std::make_shared<CSettingPath>(id, label, value, GetSettingsManager());
  if (setting == NULL)
    return NULL;
...
std::shared_ptr<CSettingDate> CGUIDialogSettingsManualBase::AddDate(SettingGroupPtr group,
                                                                    const std::string& id,
                                                                    int label,
                                                                    SettingLevel level,
                                                                    std::string value,
                                                                    ...
                                                                    int help /* = -1 */)
{
  ...
  std::shared_ptr<CSettingDate> setting =
...
std::shared_ptr<CSettingTime> CGUIDialogSettingsManualBase::AddTime(SettingGroupPtr group,
                                                                    const std::string& id,
                                                                    int label,
                                                                    SettingLevel level,
                                                                    std::string value,
                                                                    ...
                                                                    int help /* = -1 */)
{
  ...
  std::shared_ptr<CSettingTime> setting =
      std::make_shared<CSettingTime>(id, label, value, GetSettingsManager());
  if (setting == NULL)
    return NULL;
...
std::shared_ptr<CSettingString> CGUIDialogSettingsManualBase::AddSpinner(
    ...
    int help /* = -1 */)
{
  if (group == NULL || id.empty() || label < 0 || filler == NULL || GetSetting(id) != NULL)
    return NULL;
...
std::shared_ptr<CSettingInt> CGUIDialogSettingsManualBase::AddSpinner(SettingGroupPtr group,
                                                                      const std::string& id,
                                                                      int label,
                                                                      SettingLevel level,
                                                                      int value,
                                                                      ...
                                                                      int help /* = -1 */)
{
  ...
  std::shared_ptr<CSettingInt> setting =
      std::make_shared<CSettingInt>(id, label, value, GetSettingsManager());
  if (setting == NULL)
    return NULL;
...
std::shared_ptr<CSettingInt> CGUIDialogSettingsManualBase::AddSpinner(
    ...
    int help /* = -1 */)
{
  if (group == NULL || id.empty() || label < 0 || entries.empty() || GetSetting(id) != NULL)
    return NULL;
    ...
    int help /* = -1 */)
{
  ...
  std::shared_ptr<CSettingNumber> setting =
      std::make_shared<CSettingNumber>(id, label, value, GetSettingsManager());
  if (setting == NULL)
    return NULL;
    ...
    int help /* = -1 */)
{
  ...
  std::shared_ptr<CSettingString> settingDefinition =
      std::make_shared<CSettingString>(id, GetSettingsManager());
  ...
  for (std::vector<std::string>::const_iterator itValue = values.begin(); itValue != values.end();
       ++itValue)
    ...
    int help /* = -1 */)
{
  ...
  std::shared_ptr<CSettingInt> settingDefinition =
  ...
  std::vector<CVariant> valueList;
  for (std::vector<int>::const_iterator itValue = values.begin(); itValue != values.end();
       ++itValue)
    valueList.push_back(CVariant(*itValue));
  SettingList settingValues;
  if (!CSettingUtils::ValuesToList(setting, valueList, settingValues))
...
std::shared_ptr<CSettingInt> CGUIDialogSettingsManualBase::AddSlider(SettingGroupPtr group,
                                                                     const std::string& id,
                                                                     int label,
                                                                     SettingLevel level,
                                                                     int value,
...
std::shared_ptr<CSettingNumber> CGUIDialogSettingsManualBase::AddSlider(SettingGroupPtr group,
                                                                        const std::string& id,
                                                                        int label,
                                                                        SettingLevel level,
                                                                        float value,
...
std::shared_ptr<CSettingList> CGUIDialogSettingsManualBase::AddPercentageRange(
    ...
    int help /* = -1 */)
{
  return AddRange(group, id, label, level, valueLower, valueUpper, 0, step, 100, "percentage",
                  formatLabel, valueFormatLabel, "", delayed, visible, help);
}
...
{
  return AddRange(group, id, label, level, valueLower, valueUpper, 0, step, 100, "percentage",
                  formatLabel, -1, valueFormatString, delayed, visible, help);
}

std::shared_ptr<CSettingList> CGUIDialogSettingsManualBase::AddRange(SettingGroupPtr group,
                                                                     const std::string& id,
                                                                     int label,
                                                                     SettingLevel level,
                                                                     int valueLower,
                                                                     ...
                                                                     int help /* = -1 */)
{
  return AddRange(group, id, label, level, valueLower, valueUpper, minimum, step, maximum,
                  "integer", formatLabel, valueFormatLabel, "", delayed, visible, help);
}
...
{
  return AddRange(group, id, label, level, valueLower, valueUpper, minimum, step, maximum,
                  "integer", formatLabel, -1, valueFormatString, delayed, visible, help);
}
...
std::shared_ptr<CSettingList> CGUIDialogSettingsManualBase::AddRange(SettingGroupPtr group,
                                                                     ...
                                                                     int help /* = -1 */)
{
  return AddRange(group, id, label, level, valueLower, valueUpper, minimum, step, maximum, "number",
                  formatLabel, valueFormatLabel, "", delayed, visible, help);
}
...
std::shared_ptr<CSettingList> CGUIDialogSettingsManualBase::AddDateRange(
    ...
    int help /* = -1 */)
{
  return AddRange(group, id, label, level, valueLower, valueUpper, minimum, step, maximum, "date",
                  formatLabel, valueFormatLabel, "", delayed, visible, help);
}
...
std::shared_ptr<CSettingList> CGUIDialogSettingsManualBase::AddTimeRange(
    ...
    int help /* = -1 */)
{
  return AddRange(group, id, label, level, valueLower, valueUpper, minimum, step, maximum, "time",
                  formatLabel, valueFormatLabel, "", delayed, visible, help);
}
    ...
    int help)
{
  ...
  setting->SetControl(
      GetRangeControl(format, delayed, formatLabel, valueFormatLabel, valueFormatString));
    ...
    int help)
{
  ...
  std::shared_ptr<CSettingNumber> settingDefinition =
      std::make_shared<CSettingNumber>(id, GetSettingsManager());
  if (settingDefinition == NULL)
    return NULL;
...
void CGUIDialogSettingsManualBase::setSettingDetails(std::shared_ptr<CSetting> setting,
                                                     SettingLevel level,
                                                     bool visible,
                                                     int help)
{
...
std::shared_ptr<ISettingControl> CGUIDialogSettingsManualBase::GetTitleControl(
    bool separatorBelowLabel /* = true */, bool hideSeparator /* = false */)
{
