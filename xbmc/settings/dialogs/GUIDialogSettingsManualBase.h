...
protected:
  ...
  std::shared_ptr<CSettingGroup> AddGroup(std::shared_ptr<CSettingCategory> category,
                                          int label = -1,
                                          int help = -1,
                                          bool separatorBelowLabel = true,
                                          bool hideSeparator = false);
  // checkmark control
  std::shared_ptr<CSettingBool> AddToggle(std::shared_ptr<CSettingGroup> group,
                                          const std::string& id,
                                          int label,
                                          SettingLevel level,
                                          bool value,
                                          ...
                                          int help = -1);
  // edit controls
  std::shared_ptr<CSettingInt> AddEdit(std::shared_ptr<CSettingGroup> group,
                                       const std::string& id,
                                       int label,
                                       SettingLevel level,
                                       int value,
                                       ...
                                       bool visible = true,
                                       int help = -1);
  std::shared_ptr<CSettingNumber> AddEdit(std::shared_ptr<CSettingGroup> group,
                                          const std::string& id,
                                          int label,
                                          SettingLevel level,
                                          float value,
                                          ...
                                          bool visible = true,
                                          int help = -1);
  std::shared_ptr<CSettingString> AddEdit(std::shared_ptr<CSettingGroup> group,
                                          const std::string& id,
                                          int label,
                                          SettingLevel level,
                                          std::string value,
                                          ...
                                          bool visible = true,
                                          int help = -1);
  std::shared_ptr<CSettingString> AddIp(std::shared_ptr<CSettingGroup> group,
                                        const std::string& id,
                                        int label,
                                        SettingLevel level,
                                        std::string value,
                                        ...
                                        bool visible = true,
                                        int help = -1);
  std::shared_ptr<CSettingString> AddPasswordMd5(std::shared_ptr<CSettingGroup> group,
                                                 const std::string& id,
                                                 int label,
                                                 SettingLevel level,
                                                 std::string value,
                                                 ...
                                                 int help = -1);
  // button controls
  std::shared_ptr<CSettingAction> AddButton(std::shared_ptr<CSettingGroup> group,
                                            const std::string& id,
                                            int label,
                                            SettingLevel level,
                                            ...
                                            bool visible = true,
                                            int help = -1);
  std::shared_ptr<CSettingString> AddInfoLabelButton(std::shared_ptr<CSettingGroup> group,
                                                     const std::string& id,
                                                     int label,
                                                     SettingLevel level,
                                                     std::string info,
                                                     bool visible = true,
                                                     int help = -1);
  std::shared_ptr<CSettingAddon> AddAddon(std::shared_ptr<CSettingGroup> group,
                                          const std::string& id,
                                          int label,
                                          SettingLevel level,
                                          std::string value,
  ...
  std::shared_ptr<CSettingPath> AddPath(
      ...
      bool visible = true,
      int help = -1);
  std::shared_ptr<CSettingDate> AddDate(std::shared_ptr<CSettingGroup> group,
                                        const std::string& id,
                                        int label,
                                        SettingLevel level,
                                        std::string value,
                                        ...
                                        bool visible = true,
                                        int help = -1);
  std::shared_ptr<CSettingTime> AddTime(std::shared_ptr<CSettingGroup> group,
                                        const std::string& id,
                                        int label,
                                        SettingLevel level,
                                        std::string value,
  ...
  // spinner controls
  std::shared_ptr<CSettingString> AddSpinner(std::shared_ptr<CSettingGroup> group,
                                             const std::string& id,
                                             int label,
                                             SettingLevel level,
                                             std::string value,
                                             ...
                                             bool visible = true,
                                             int help = -1);
  std::shared_ptr<CSettingInt> AddSpinner(std::shared_ptr<CSettingGroup> group,
                                          const std::string& id,
                                          int label,
                                          SettingLevel level,
                                          int value,
  ...
  std::shared_ptr<CSettingInt> AddSpinner(std::shared_ptr<CSettingGroup> group,
                                          ...
                                          bool visible = true,
                                          int help = -1);
  std::shared_ptr<CSettingNumber> AddSpinner(std::shared_ptr<CSettingGroup> group,
                                             const std::string& id,
                                             int label,
                                             SettingLevel level,
                                             float value,
  ...
  // list controls
  std::shared_ptr<CSettingString> AddList(std::shared_ptr<CSettingGroup> group,
                                          const std::string& id,
                                          int label,
                                          SettingLevel level,
                                          std::string value,
                                          ...
                                          bool visible = true,
                                          int help = -1);
  std::shared_ptr<CSettingInt> AddList(std::shared_ptr<CSettingGroup> group,
                                       const std::string& id,
                                       int label,
                                       SettingLevel level,
                                       int value,
  ...
  std::shared_ptr<CSettingInt> AddList(std::shared_ptr<CSettingGroup> group,
                                       ...
                                       bool visible = true,
                                       int help = -1);
  std::shared_ptr<CSettingList> AddList(std::shared_ptr<CSettingGroup> group,
                                        const std::string& id,
                                        int label,
                                        SettingLevel level,
  ...
  // slider controls
  std::shared_ptr<CSettingInt> AddPercentageSlider(std::shared_ptr<CSettingGroup> group,
                                                   const std::string& id,
                                                   int label,
                                                   SettingLevel level,
                                                   int value,
  ...
  std::shared_ptr<CSettingInt> AddPercentageSlider(std::shared_ptr<CSettingGroup> group,
                                                   ...
                                                   bool visible = true,
                                                   int help = -1);
  std::shared_ptr<CSettingInt> AddSlider(std::shared_ptr<CSettingGroup> group,
                                         const std::string& id,
                                         int label,
                                         SettingLevel level,
                                         int value,
  ...
  std::shared_ptr<CSettingInt> AddSlider(std::shared_ptr<CSettingGroup> group,
                                         ...
                                         bool visible = true,
                                         int help = -1);
  std::shared_ptr<CSettingNumber> AddSlider(std::shared_ptr<CSettingGroup> group,
                                            const std::string& id,
                                            int label,
                                            SettingLevel level,
                                            float value,
  ...
  // range controls
  std::shared_ptr<CSettingList> AddPercentageRange(std::shared_ptr<CSettingGroup> group,
                                                   const std::string& id,
                                                   int label,
                                                   SettingLevel level,
                                                   int valueLower,
  ...
  std::shared_ptr<CSettingList> AddPercentageRange(std::shared_ptr<CSettingGroup> group,
                                                   ...
                                                   bool visible = true,
                                                   int help = -1);
  std::shared_ptr<CSettingList> AddRange(std::shared_ptr<CSettingGroup> group,
                                         const std::string& id,
                                         int label,
                                         SettingLevel level,
                                         int valueLower,
  ...
  std::shared_ptr<CSettingList> AddRange(std::shared_ptr<CSettingGroup> group,
                                         ...
                                         bool visible = true,
                                         int help = -1);
  std::shared_ptr<CSettingList> AddDateRange(std::shared_ptr<CSettingGroup> group,
                                             const std::string& id,
                                             int label,
                                             SettingLevel level,
                                             int valueLower,
  ...
  std::shared_ptr<CSettingList> AddDateRange(std::shared_ptr<CSettingGroup> group,
                                             ...
                                             bool visible = true,
                                             int help = -1);
  std::shared_ptr<CSettingList> AddTimeRange(std::shared_ptr<CSettingGroup> group,
                                             const std::string& id,
                                             int label,
                                             SettingLevel level,
                                             int valueLower,
...
private:
  ...
  void setSettingDetails(std::shared_ptr<CSetting> setting,
                         SettingLevel level,
                         bool visible,
                         int help);
