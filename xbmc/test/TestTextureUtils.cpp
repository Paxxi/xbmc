...
const TestFiles test_files[] = {
    ...
    {"/path/to/image/file.jpg", "", "size=thumb",
     "image://%2fpath%2fto%2fimage%2ffile.jpg/transform?size=thumb"},
    ...
    {"image://%2fpath%2fto%2fimage%2ffile.jpg/", "", "",
     "image://%2fpath%2fto%2fimage%2ffile.jpg/"},
    {"image://%2fpath%2fto%2fimage%2ffile.jpg/transform?size=thumb", "", "size=thumb",
     "image://%2fpath%2fto%2fimage%2ffile.jpg/transform?size=thumb"}};


class TestTextureUtils : public ::testing::TestWithParam<TestFiles>
{
};
...
TEST_P(TestTextureUtils, GetWrappedImageURL)
{
  ...
  std::string out =
      CTextureUtils::GetWrappedImageURL(testFiles.in, testFiles.type, testFiles.options);
