...
{
public:
  explicit CPVRUpdateAddonsJob(const std::string& changedAddonId)
    : m_changedAddonId(changedAddonId){};
...
{
public:
  CPVRSearchMissingChannelIconsJob(const std::vector<std::shared_ptr<CPVRChannelGroup>>& groups,
                                   bool bUpdateDb);
...
{
public:
  CPVRClientConnectionJob(CPVRClient* client,
