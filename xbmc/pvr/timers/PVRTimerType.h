...
public:
  ...
  /*!
     ...
     * @return A timer type instance.
     */
  static CPVRTimerTypePtr CreateFromAttributes(unsigned int iMustHaveAttr,
  ...
  /*!
     ...
     */
  bool SupportsStartEndMargin() const
  {
    return (m_iAttributes & PVR_TIMER_TYPE_SUPPORTS_START_END_MARGIN) > 0;
  }
