...
struct PVRChannelGroupMember
{
  ...
  PVRChannelGroupMember(const CPVRChannelPtr _channel,
...
/** A group of channels */
class CPVRChannelGroup : public Observable, public ISettingCallback
{
...
public:
  ...
  /*!
     ...
     */
  virtual bool AddToGroup(const CPVRChannelPtr& channel,
  ...
  /*!
     ...
     * @return The channel or nullptr if it wasn't found.
     */
  std::shared_ptr<CPVRChannel> GetPreviousChannel(
  ...
  /*!
     ...
     * @return The tags.
     */
  std::vector<std::shared_ptr<CPVREpgInfoTag>> GetEPGAll(
...
protected:
  ...
  /*!
     ...
     * @return True if everything went well, false otherwise.
     */
  virtual bool AddAndUpdateChannels(const CPVRChannelGroup& channels,
                                    bool bUseBackendChannelNumbers);
  ...
  bool m_bUsingBackendChannelOrder =
      false; /*!< true to use the channel order from backends, false otherwise */
  bool m_bUsingBackendChannelNumbers =
      false; /*!< true to use the channel numbers from 1 backend, false otherwise */
  bool m_bPreventSortAndRenumber =
      false; /*!< true when sorting and renumbering should not be done after adding/updating channels to the group */
