...
public:
  ...
  /*!
     ...
     */
  std::vector<CPVRChannelGroupPtr> GetGroupsByChannel(const CPVRChannelPtr& channel,
...
private:
  ...
  bool
      m_bRadio; /*!< true if this is a container for radio channels, false if it is for tv channels */
