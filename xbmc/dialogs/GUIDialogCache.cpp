...
CGUIDialogCache::CGUIDialogCache(DWORD dwDelay, std::string  strHeader, std::string  strMsg) : CThread("GUIDialogCache"),
  m_strHeader(std::move(strHeader)),
  m_strLinePrev(std::move(strMsg))
{
  bSentCancel = false;
