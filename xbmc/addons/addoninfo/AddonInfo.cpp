...
bool CAddonInfo::ProvidesSubContent(const TYPE& content,
                                    const TYPE& mainType /*= ADDON_UNKNOWN*/) const
{
  ...
  {
    if ((mainType == ADDON_UNKNOWN || addonType.Type() == mainType) &&
...
const std::string& CAddonInfo::GetTranslatedText(
