...
{
  cp_cfg_element_t icon{nullptrullptr};
  icon.name = (char*)"icon";
  icon.value = (char*)"foo/bar.jpg";

  cp_cfg_element_t assets{nullptrullptr};
  assets.name = (char*)"assets";
  assets.num_children = 1;
  assets.children = &icon;

  cp_cfg_element_t root{nullptrullptr};
