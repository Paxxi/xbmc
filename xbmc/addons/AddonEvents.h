...
{
  std::string id;
  explicit AddonEvent(std::string id)
    : id(std::move(id)){};
...
{
  explicit Enabled(std::string id)
    : AddonEvent(std::move(id))
  {
  }
};
...
{
  explicit Disabled(std::string id)
    : AddonEvent(std::move(id))
  {
  }
};
...
{
  explicit MetadataChanged(std::string id)
    : AddonEvent(std::move(id))
  {
  }
};
...
{
  explicit ReInstalled(std::string id)
    : AddonEvent(std::move(id))
  {
  }
};
...
{
  explicit UnInstalled(std::string id)
    : AddonEvent(std::move(id))
  {
  }
};
