...
extern "C"
{
  ...
  int Interface_GUIDialogNumeric::show_and_verify_password(void* kodiBase,
                                                           const char* password,
                                                           const char* heading,
                                                           int retries)
  {
  ...
  bool Interface_GUIDialogNumeric::show_and_verify_input(void* kodiBase,
  ...
  bool Interface_GUIDialogNumeric::show_and_get_ip_address(void* kodiBase,
  ...
  bool Interface_GUIDialogNumeric::show_and_get_number(void* kodiBase,
  ...
  bool Interface_GUIDialogNumeric::show_and_get_seconds(void* kodiBase,
                                                        const char* time_in,
                                                        char** time_out,
                                                        const char* heading)
  {
