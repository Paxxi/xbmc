...
extern "C"
{
  ...
  void Interface_GUIDialogExtendedProgress::set_title(void* kodiBase,
                                                      void* handle,
                                                      const char* title)
  {
    CAddonDll* addon = static_cast<CAddonDll*>(kodiBase);
  ...
  void Interface_GUIDialogExtendedProgress::set_percentage(void* kodiBase,
                                                           void* handle,
                                                           float percentage)
  {
    CAddonDll* addon = static_cast<CAddonDll*>(kodiBase);
  ...
  void Interface_GUIDialogExtendedProgress::set_progress(void* kodiBase,
                                                         void* handle,
                                                         int currentItem,
                                                         int itemCount)
  {
