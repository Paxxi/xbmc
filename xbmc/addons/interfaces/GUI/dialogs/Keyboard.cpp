...
extern "C"
{
  ...
  bool Interface_GUIDialogKeyboard::show_and_get_input_with_head(void* kodiBase,
                                                                 const char* text_in,
                                                                 char** text_out,
                                                                 const char* heading,
  ...
  bool Interface_GUIDialogKeyboard::show_and_get_input(void* kodiBase,
                                                       const char* text_in,
                                                       char** text_out,
                                                       bool allow_empty_result,
                                                       unsigned int auto_close_ms)
  ...
  bool Interface_GUIDialogKeyboard::show_and_get_new_password_with_head(void* kodiBase,
  ...
  bool Interface_GUIDialogKeyboard::show_and_get_new_password(void* kodiBase,
                                                              const char* password_in,
                                                              char** password_out,
                                                              unsigned int auto_close_ms)
  {
  ...
  bool Interface_GUIDialogKeyboard::show_and_verify_new_password_with_head(
      void* kodiBase,
      char** password_out,
      const char* heading,
      bool allowEmpty,
  ...
  bool Interface_GUIDialogKeyboard::show_and_verify_new_password(void* kodiBase,
                                                                 char** password_out,
                                                                 unsigned int auto_close_ms)
  {
    CAddonDll* addon = static_cast<CAddonDll*>(kodiBase);
  ...
  int Interface_GUIDialogKeyboard::show_and_verify_password(void* kodiBase,
                                                            const char* password_in,
                                                            char** password_out,
                                                            const char* heading,
                                                            int retries,
  ...
  bool Interface_GUIDialogKeyboard::show_and_get_filter(void* kodiBase,
                                                        const char* text_in,
                                                        char** text_out,
                                                        bool searching,
                                                        unsigned int auto_close_ms)
  ...
  bool Interface_GUIDialogKeyboard::send_text_to_active_keyboard(void* kodiBase,
                                                                 const char* text,
                                                                 bool close_keyboard)
  {
    CAddonDll* addon = static_cast<CAddonDll*>(kodiBase);
