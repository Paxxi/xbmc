...
extern "C"
{
  ...
  bool Interface_GUIDialogFileBrowser::show_and_get_directory(void* kodiBase,
                                                              const char* shares,
                                                              const char* heading,
                                                              const char* path_in,
                                                              char** path_out,
  ...
  bool Interface_GUIDialogFileBrowser::show_and_get_file(void* kodiBase,
                                                         const char* shares,
                                                         const char* mask,
                                                         const char* heading,
                                                         const char* path_in,
  ...
  bool Interface_GUIDialogFileBrowser::show_and_get_file_from_dir(void* kodiBase,
  ...
  bool Interface_GUIDialogFileBrowser::show_and_get_file_list(void* kodiBase,
                                                              const char* shares,
                                                              const char* mask,
                                                              const char* heading,
                                                              char*** file_list,
  ...
  bool Interface_GUIDialogFileBrowser::show_and_get_source(void* kodiBase,
                                                           const char* path_in,
                                                           char** path_out,
  ...
  bool Interface_GUIDialogFileBrowser::show_and_get_image(
      void* kodiBase, const char* shares, const char* heading, const char* path_in, char** path_out)
  {
    CAddonDll* addon = static_cast<CAddonDll*>(kodiBase);
    if (!addon)
    {
  ...
  bool Interface_GUIDialogFileBrowser::show_and_get_image_list(void* kodiBase,
                                                               const char* shares,
                                                               const char* heading,
                                                               char*** file_list,
                                                               unsigned int* entries)
  {
    ...
    if (!shares || !heading || !file_list || !entries)
    {
      CLog::Log(LOGERROR,
                "Interface_GUIDialogFileBrowser::%s - invalid handler data (shares='%p', "
                "heading='%p', file_list='%p', entries='%p') on addon '%s'",
                __FUNCTION__, shares, heading, static_cast<void*>(file_list),
                static_cast<void*>(entries), addon->ID().c_str());
      return false;
    }
  ...
  void Interface_GUIDialogFileBrowser::clear_file_list(void* kodiBase,
                                                       char*** file_list,
                                                       unsigned int entries)
  {
    CAddonDll* addon = static_cast<CAddonDll*>(kodiBase);
