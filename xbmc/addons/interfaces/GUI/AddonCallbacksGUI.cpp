  ...
  , m_callbacks(new CB_GUILib)
{
  ...
  m_callbacks->Window_GetControl_SettingsSlider =
      CAddonCallbacksGUI::Window_GetControl_SettingsSlider;
  ...
  m_callbacks->Control_RadioButton_SetSelected =
  ...
  m_callbacks->Control_Progress_GetDescription =
      CAddonCallbacksGUI::Control_Progress_GetDescription;
  ...
  m_callbacks->Control_Slider_SetFloatInterval =
      CAddonCallbacksGUI::Control_Slider_SetFloatInterval;

  m_callbacks->Control_SettingsSlider_SetVisible =
      CAddonCallbacksGUI::Control_SettingsSlider_SetVisible;
  m_callbacks->Control_SettingsSlider_SetText = CAddonCallbacksGUI::Control_SettingsSlider_SetText;
  m_callbacks->Control_SettingsSlider_GetDescription =
      CAddonCallbacksGUI::Control_SettingsSlider_GetDescription;
  m_callbacks->Control_SettingsSlider_SetIntRange =
      CAddonCallbacksGUI::Control_SettingsSlider_SetIntRange;
  m_callbacks->Control_SettingsSlider_SetIntValue =
  ...
  m_callbacks->Control_SettingsSlider_SetIntInterval =
      CAddonCallbacksGUI::Control_SettingsSlider_SetIntInterval;
  m_callbacks->Control_SettingsSlider_SetPercentage =
      CAddonCallbacksGUI::Control_SettingsSlider_SetPercentage;
  m_callbacks->Control_SettingsSlider_GetPercentage =
      CAddonCallbacksGUI::Control_SettingsSlider_GetPercentage;
  m_callbacks->Control_SettingsSlider_SetFloatRange =
      CAddonCallbacksGUI::Control_SettingsSlider_SetFloatRange;
  m_callbacks->Control_SettingsSlider_SetFloatValue =
      CAddonCallbacksGUI::Control_SettingsSlider_SetFloatValue;
  m_callbacks->Control_SettingsSlider_GetFloatValue =
      CAddonCallbacksGUI::Control_SettingsSlider_GetFloatValue;
  m_callbacks->Control_SettingsSlider_SetFloatInterval =
      CAddonCallbacksGUI::Control_SettingsSlider_SetFloatInterval;

  m_callbacks->Dialog_Keyboard_ShowAndGetInputWithHead =
      CAddonCallbacksGUI::Dialog_Keyboard_ShowAndGetInputWithHead;
  m_callbacks->Dialog_Keyboard_ShowAndGetInput =
      CAddonCallbacksGUI::Dialog_Keyboard_ShowAndGetInput;
  m_callbacks->Dialog_Keyboard_ShowAndGetNewPasswordWithHead =
      CAddonCallbacksGUI::Dialog_Keyboard_ShowAndGetNewPasswordWithHead;
  m_callbacks->Dialog_Keyboard_ShowAndGetNewPassword =
      CAddonCallbacksGUI::Dialog_Keyboard_ShowAndGetNewPassword;
  m_callbacks->Dialog_Keyboard_ShowAndVerifyNewPasswordWithHead =
      CAddonCallbacksGUI::Dialog_Keyboard_ShowAndVerifyNewPasswordWithHead;
  m_callbacks->Dialog_Keyboard_ShowAndVerifyNewPassword =
      CAddonCallbacksGUI::Dialog_Keyboard_ShowAndVerifyNewPassword;
  m_callbacks->Dialog_Keyboard_ShowAndVerifyPassword =
      CAddonCallbacksGUI::Dialog_Keyboard_ShowAndVerifyPassword;
  m_callbacks->Dialog_Keyboard_ShowAndGetFilter =
      CAddonCallbacksGUI::Dialog_Keyboard_ShowAndGetFilter;
  m_callbacks->Dialog_Keyboard_SendTextToActiveKeyboard =
      CAddonCallbacksGUI::Dialog_Keyboard_SendTextToActiveKeyboard;
  m_callbacks->Dialog_Keyboard_isKeyboardActivated =
      CAddonCallbacksGUI::Dialog_Keyboard_isKeyboardActivated;

  m_callbacks->Dialog_Numeric_ShowAndVerifyNewPassword =
      CAddonCallbacksGUI::Dialog_Numeric_ShowAndVerifyNewPassword;
  m_callbacks->Dialog_Numeric_ShowAndVerifyPassword =
      CAddonCallbacksGUI::Dialog_Numeric_ShowAndVerifyPassword;
  m_callbacks->Dialog_Numeric_ShowAndVerifyInput =
  ...
  m_callbacks->Dialog_Numeric_ShowAndGetIPAddress =
      CAddonCallbacksGUI::Dialog_Numeric_ShowAndGetIPAddress;
  m_callbacks->Dialog_Numeric_ShowAndGetNumber =
      CAddonCallbacksGUI::Dialog_Numeric_ShowAndGetNumber;
  m_callbacks->Dialog_Numeric_ShowAndGetSeconds =
      CAddonCallbacksGUI::Dialog_Numeric_ShowAndGetSeconds;

  m_callbacks->Dialog_FileBrowser_ShowAndGetFile =
      CAddonCallbacksGUI::Dialog_FileBrowser_ShowAndGetFile;

  m_callbacks->Dialog_OK_ShowAndGetInputSingleText =
      CAddonCallbacksGUI::Dialog_OK_ShowAndGetInputSingleText;
  m_callbacks->Dialog_OK_ShowAndGetInputLineText =
      CAddonCallbacksGUI::Dialog_OK_ShowAndGetInputLineText;

  m_callbacks->Dialog_YesNo_ShowAndGetInputSingleText =
      CAddonCallbacksGUI::Dialog_YesNo_ShowAndGetInputSingleText;
  m_callbacks->Dialog_YesNo_ShowAndGetInputLineText =
      CAddonCallbacksGUI::Dialog_YesNo_ShowAndGetInputLineText;
  m_callbacks->Dialog_YesNo_ShowAndGetInputLineButtonText =
      CAddonCallbacksGUI::Dialog_YesNo_ShowAndGetInputLineButtonText;
...
GUIHANDLE CAddonCallbacksGUI::Window_New(void* addonData,
                                         ...
                                         bool asDialog)
{
  ...
  if (!forceFallback)
  {
    ...
    if (!XFILE::CFile::Exists(strSkinPath))
    {
      ...
      std::string basePath =
          URIUtils::AddFileToFolder(guiHelper->m_addon->Path(), "resources", "skins",
  ...
  if (forceFallback)
  {
    ...
    addonInfo->SetPath(
        URIUtils::AddFileToFolder(guiHelper->m_addon->Path(), "resources", "skins", defaultSkin));
    ...
    {
      CLog::Log(LOGERROR,
                "Window_New: %s/%s - XML File '%s' for Window is missing, contact Developer '%s' "
                "of this AddOn",
                CAddonInfo::TranslateType(guiHelper->m_addon->Type()).c_str(),
                guiHelper->m_addon->Name().c_str(), strSkinPath.c_str(),
                guiHelper->m_addon->Author().c_str());
      return NULL;
    }
  }
  ...
  if (CServiceBroker::GetGUI()->GetWindowManager().GetWindow(WINDOW_ADDON_END))
  {
    ...
    CLog::Log(LOGERROR, "Window_New: %s/%s - maximum number of windows reached",
              CAddonInfo::TranslateType(guiHelper->m_addon->Type()).c_str(),
              guiHelper->m_addon->Name().c_str());
    return NULL;
  }
  while (id < WINDOW_ADDON_END &&
         CServiceBroker::GetGUI()->GetWindowManager().GetWindow(id) != NULL)
    id++;
  Unlock();
...
void CAddonCallbacksGUI::Window_Delete(void* addonData, GUIHANDLE handle)
{
  ...
  if (!handle)
  {
    CLog::Log(LOGERROR, "Window_Show: %s/%s - No Window",
              CAddonInfo::TranslateType(guiHelper->m_addon->Type()).c_str(),
              guiHelper->m_addon->Name().c_str());
    return;
  }
  ...
  CGUIWindow* pWindow =
      CServiceBroker::GetGUI()->GetWindowManager().GetWindow(pAddonWindow->m_iWindowId);
  if (!pWindow)
    return;

  Lock();
  // first change to an existing window
  if (CServiceBroker::GetGUI()->GetWindowManager().GetActiveWindow() == pAddonWindow->m_iWindowId &&
...
void CAddonCallbacksGUI::Window_SetCallbacks(void* addonData,
                                             GUIHANDLE handle,
...
bool CAddonCallbacksGUI::Window_Show(void* addonData, GUIHANDLE handle)
{
  ...
  if (pAddonWindow->m_iOldWindowId != pAddonWindow->m_iWindowId &&
      pAddonWindow->m_iWindowId != CServiceBroker::GetGUI()->GetWindowManager().GetActiveWindow())
...
void CAddonCallbacksGUI::Window_SetProperty(void* addonData,
                                            GUIHANDLE handle,
                                            const char* key,
                                            const char* value)
{
  ...
  if (!handle || !key || !value)
  {
    CLog::Log(LOGERROR, "Window_SetProperty: %s/%s - No Window or NULL key or value",
              CAddonInfo::TranslateType(guiHelper->m_addon->Type()).c_str(),
              guiHelper->m_addon->Name().c_str());
    return;
  }
...
void CAddonCallbacksGUI::Window_SetPropertyInt(void* addonData,
                                               GUIHANDLE handle,
                                               const char* key,
                                               int value)
{
  ...
  if (!handle || !key)
  {
    CLog::Log(LOGERROR, "Window_SetPropertyInt: %s/%s - No Window or NULL key",
              CAddonInfo::TranslateType(guiHelper->m_addon->Type()).c_str(),
              guiHelper->m_addon->Name().c_str());
    return;
  }
...
void CAddonCallbacksGUI::Window_SetPropertyBool(void* addonData,
                                                GUIHANDLE handle,
                                                const char* key,
                                                bool value)
{
  ...
  if (!handle || !key)
  {
    CLog::Log(LOGERROR, "Window_SetPropertyBool: %s/%s - No Window or NULL key",
              CAddonInfo::TranslateType(guiHelper->m_addon->Type()).c_str(),
              guiHelper->m_addon->Name().c_str());
    return;
  }
...
void CAddonCallbacksGUI::Window_SetPropertyDouble(void* addonData,
                                                  GUIHANDLE handle,
                                                  const char* key,
                                                  double value)
{
  ...
  if (!handle || !key)
  {
    CLog::Log(LOGERROR, "Window_SetPropertyDouble: %s/%s - No Window or NULL key",
              CAddonInfo::TranslateType(guiHelper->m_addon->Type()).c_str(),
              guiHelper->m_addon->Name().c_str());
    return;
  }
...
const char* CAddonCallbacksGUI::Window_GetProperty(void* addonData,
                                                   GUIHANDLE handle,
                                                   const char* key)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
  ...
  if (!handle || !key)
  {
    CLog::Log(LOGERROR, "Window_GetProperty: %s/%s - No Window or NULL key",
              CAddonInfo::TranslateType(guiHelper->m_addon->Type()).c_str(),
              guiHelper->m_addon->Name().c_str());
    return NULL;
  }
...
int CAddonCallbacksGUI::Window_GetPropertyInt(void* addonData, GUIHANDLE handle, const char* key)
{
  ...
  if (!handle || !key)
  {
    CLog::Log(LOGERROR, "Window_GetPropertyInt: %s/%s - No Window or NULL key",
              CAddonInfo::TranslateType(guiHelper->m_addon->Type()).c_str(),
              guiHelper->m_addon->Name().c_str());
    return -1;
  }
...
bool CAddonCallbacksGUI::Window_GetPropertyBool(void* addonData, GUIHANDLE handle, const char* key)
{
  ...
  if (!handle || !key)
  {
    CLog::Log(LOGERROR, "Window_GetPropertyBool: %s/%s - No Window or NULL key",
              CAddonInfo::TranslateType(guiHelper->m_addon->Type()).c_str(),
              guiHelper->m_addon->Name().c_str());
    return false;
  }
...
double CAddonCallbacksGUI::Window_GetPropertyDouble(void* addonData,
                                                    GUIHANDLE handle,
                                                    const char* key)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
  ...
  if (!handle || !key)
  {
    CLog::Log(LOGERROR, "Window_GetPropertyDouble: %s/%s - No Window or NULL key",
              CAddonInfo::TranslateType(guiHelper->m_addon->Type()).c_str(),
              guiHelper->m_addon->Name().c_str());
    return 0.0;
  }
...
GUIHANDLE CAddonCallbacksGUI::Window_AddItem(void* addonData,
                                             GUIHANDLE handle,
                                             GUIHANDLE item,
                                             int itemPosition)
{
...
GUIHANDLE CAddonCallbacksGUI::Window_AddStringItem(void* addonData,
                                                   GUIHANDLE handle,
                                                   const char* itemName,
                                                   int itemPosition)
{
...
void CAddonCallbacksGUI::Window_SetCurrentListPosition(void* addonData,
                                                       GUIHANDLE handle,
                                                       int listPos)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
...
GUIHANDLE CAddonCallbacksGUI::Window_GetControl_Spin(void* addonData,
                                                     GUIHANDLE handle,
                                                     int controlId)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
...
GUIHANDLE CAddonCallbacksGUI::Window_GetControl_Button(void* addonData,
                                                       GUIHANDLE handle,
                                                       int controlId)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
...
GUIHANDLE CAddonCallbacksGUI::Window_GetControl_RadioButton(void* addonData,
                                                            GUIHANDLE handle,
                                                            int controlId)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
...
GUIHANDLE CAddonCallbacksGUI::Window_GetControl_Edit(void* addonData,
                                                     GUIHANDLE handle,
                                                     int controlId)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
...
GUIHANDLE CAddonCallbacksGUI::Window_GetControl_Progress(void* addonData,
                                                         GUIHANDLE handle,
                                                         int controlId)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
...
GUIHANDLE CAddonCallbacksGUI::Window_GetControl_RenderAddon(void* addonData,
                                                            GUIHANDLE handle,
                                                            int controlId)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
...
void CAddonCallbacksGUI::Window_SetControlLabel(void* addonData,
                                                GUIHANDLE handle,
                                                int controlId,
                                                const char* label)
{
...
void CAddonCallbacksGUI::Control_Spin_SetText(void* addonData,
...
void CAddonCallbacksGUI::Control_Spin_AddLabel(void* addonData,
                                               GUIHANDLE spinhandle,
                                               const char* label,
                                               int iValue)
{
...
void CAddonCallbacksGUI::Control_RadioButton_SetVisible(void* addonData,
                                                        GUIHANDLE handle,
                                                        bool yesNo)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
...
void CAddonCallbacksGUI::Control_RadioButton_SetText(void* addonData,
                                                     GUIHANDLE handle,
                                                     const char* label)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
...
void CAddonCallbacksGUI::Control_RadioButton_SetSelected(void* addonData,
                                                         GUIHANDLE handle,
                                                         bool yesNo)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
...
void CAddonCallbacksGUI::Control_Progress_SetPercentage(void* addonData,
                                                        GUIHANDLE handle,
                                                        float fPercent)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
 ...
 */
GUIHANDLE CAddonCallbacksGUI::Window_GetControl_Slider(void* addonData,
                                                       GUIHANDLE handle,
                                                       int controlId)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
...
void CAddonCallbacksGUI::Control_Slider_SetIntRange(void* addonData,
                                                    GUIHANDLE handle,
                                                    int iStart,
                                                    int iEnd)
{
...
void CAddonCallbacksGUI::Control_Slider_SetIntInterval(void* addonData,
                                                       GUIHANDLE handle,
                                                       int iInterval)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
...
void CAddonCallbacksGUI::Control_Slider_SetPercentage(void* addonData,
                                                      GUIHANDLE handle,
                                                      float fPercent)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
...
void CAddonCallbacksGUI::Control_Slider_SetFloatRange(void* addonData,
                                                      GUIHANDLE handle,
                                                      float fStart,
                                                      float fEnd)
{
...
void CAddonCallbacksGUI::Control_Slider_SetFloatValue(void* addonData,
                                                      GUIHANDLE handle,
                                                      float iValue)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
...
void CAddonCallbacksGUI::Control_Slider_SetFloatInterval(void* addonData,
                                                         GUIHANDLE handle,
                                                         float fInterval)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
 ...
 */
GUIHANDLE CAddonCallbacksGUI::Window_GetControl_SettingsSlider(void* addonData,
                                                               GUIHANDLE handle,
                                                               int controlId)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
...
void CAddonCallbacksGUI::Control_SettingsSlider_SetVisible(void* addonData,
                                                           GUIHANDLE handle,
                                                           bool yesNo)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
...
void CAddonCallbacksGUI::Control_SettingsSlider_SetText(void* addonData,
                                                        GUIHANDLE handle,
                                                        const char* label)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
...
const char* CAddonCallbacksGUI::Control_SettingsSlider_GetDescription(void* addonData,
                                                                      GUIHANDLE handle)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
  if (!helper || !handle)
...
void CAddonCallbacksGUI::Control_SettingsSlider_SetIntRange(void* addonData,
                                                            GUIHANDLE handle,
                                                            int iStart,
                                                            int iEnd)
{
...
void CAddonCallbacksGUI::Control_SettingsSlider_SetIntValue(void* addonData,
                                                            GUIHANDLE handle,
                                                            int iValue)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
...
void CAddonCallbacksGUI::Control_SettingsSlider_SetIntInterval(void* addonData,
                                                               GUIHANDLE handle,
                                                               int iInterval)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
...
void CAddonCallbacksGUI::Control_SettingsSlider_SetPercentage(void* addonData,
                                                              GUIHANDLE handle,
                                                              float fPercent)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
...
void CAddonCallbacksGUI::Control_SettingsSlider_SetFloatRange(void* addonData,
                                                              GUIHANDLE handle,
                                                              float fStart,
                                                              float fEnd)
{
...
void CAddonCallbacksGUI::Control_SettingsSlider_SetFloatValue(void* addonData,
                                                              GUIHANDLE handle,
                                                              float fValue)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
...
void CAddonCallbacksGUI::Control_SettingsSlider_SetFloatInterval(void* addonData,
                                                                 GUIHANDLE handle,
                                                                 float fInterval)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
 ...
 */
GUIHANDLE CAddonCallbacksGUI::ListItem_Create(void* addonData,
                                              const char* label,
                                              const char* label2,
...
void CAddonCallbacksGUI::ListItem_SetProperty(void* addonData,
                                              GUIHANDLE handle,
                                              const char* key,
                                              const char* value)
{
...
const char* CAddonCallbacksGUI::ListItem_GetProperty(void* addonData,
                                                     GUIHANDLE handle,
                                                     const char* key)
{
  CAddonInterfaces* helper = (CAddonInterfaces*)addonData;
...
void CAddonCallbacksGUI::RenderAddon_SetCallbacks(
    void* addonData,
    GUIHANDLE handle,
    GUIHANDLE clienthandle,
...
//@{
bool CAddonCallbacksGUI::Dialog_Keyboard_ShowAndGetInputWithHead(char& aTextString,
                                                                 ...
                                                                 unsigned int autoCloseMs)
{
  ...
  bool bRet = CGUIKeyboardFactory::ShowAndGetInput(str, CVariant{strHeading}, allowEmptyResult,
...
bool CAddonCallbacksGUI::Dialog_Keyboard_ShowAndGetInput(char& aTextString,
                                                         unsigned int iMaxStringSize,
                                                         bool allowEmptyResult,
                                                         unsigned int autoCloseMs)
{
...
bool CAddonCallbacksGUI::Dialog_Keyboard_ShowAndGetNewPasswordWithHead(char& strNewPassword,
                                                                       unsigned int iMaxStringSize,
                                                                       const char* strHeading,
                                                                       bool allowEmptyResult,
                                                                       unsigned int autoCloseMs)
{
  ...
  bool bRet =
      CGUIKeyboardFactory::ShowAndGetNewPassword(str, strHeading, allowEmptyResult, autoCloseMs);
  if (bRet)
    strncpy(&strNewPassword, str.c_str(), iMaxStringSize);
  return bRet;
}

bool CAddonCallbacksGUI::Dialog_Keyboard_ShowAndGetNewPassword(char& strNewPassword,
                                                               unsigned int iMaxStringSize,
                                                               unsigned int autoCloseMs)
{
  std::string str = &strNewPassword;
...
bool CAddonCallbacksGUI::Dialog_Keyboard_ShowAndVerifyNewPasswordWithHead(
    char& strNewPassword,
    unsigned int iMaxStringSize,
    const char* strHeading,
    bool allowEmptyResult,
    unsigned int autoCloseMs)
{
  std::string str = &strNewPassword;
  bool bRet =
      CGUIKeyboardFactory::ShowAndVerifyNewPassword(str, strHeading, allowEmptyResult, autoCloseMs);
  if (bRet)
    strncpy(&strNewPassword, str.c_str(), iMaxStringSize);
  return bRet;
}

bool CAddonCallbacksGUI::Dialog_Keyboard_ShowAndVerifyNewPassword(char& strNewPassword,
                                                                  unsigned int iMaxStringSize,
                                                                  unsigned int autoCloseMs)
{
  std::string str = &strNewPassword;
...
int CAddonCallbacksGUI::Dialog_Keyboard_ShowAndVerifyPassword(char& strPassword,
                                                              unsigned int iMaxStringSize,
                                                              const char* strHeading,
                                                              int iRetries,
                                                              unsigned int autoCloseMs)
...
bool CAddonCallbacksGUI::Dialog_Keyboard_ShowAndGetFilter(char& aTextString,
                                                          unsigned int iMaxStringSize,
                                                          bool searching,
                                                          unsigned int autoCloseMs)
{
...
bool CAddonCallbacksGUI::Dialog_Keyboard_SendTextToActiveKeyboard(const char* aTextString,
                                                                  bool closeKeyboard)
{
...
//@{
bool CAddonCallbacksGUI::Dialog_Numeric_ShowAndVerifyNewPassword(char& strNewPassword,
                                                                 unsigned int iMaxStringSize)
{
  std::string str = &strNewPassword;
...
int CAddonCallbacksGUI::Dialog_Numeric_ShowAndVerifyPassword(char& strPassword,
                                                             unsigned int iMaxStringSize,
                                                             const char* strHeading,
                                                             int iRetries)
{
...
bool CAddonCallbacksGUI::Dialog_Numeric_ShowAndVerifyInput(char& strPassword,
                                                           unsigned int iMaxStringSize,
                                                           const char* strHeading,
                                                           bool bGetUserInput)
{
  std::string str = &strPassword;
  if (CGUIDialogNumeric::ShowAndVerifyInput(str, strHeading, bGetUserInput) ==
...
bool CAddonCallbacksGUI::Dialog_Numeric_ShowAndGetIPAddress(char& strIPAddress,
                                                            unsigned int iMaxStringSize,
                                                            const char* strHeading)
{
...
bool CAddonCallbacksGUI::Dialog_Numeric_ShowAndGetNumber(char& strInput,
                                                         unsigned int iMaxStringSize,
                                                         const char* strHeading,
...
bool CAddonCallbacksGUI::Dialog_Numeric_ShowAndGetSeconds(char& timeString,
                                                          unsigned int iMaxStringSize,
                                                          const char* strHeading)
{
...
//@{
bool CAddonCallbacksGUI::Dialog_FileBrowser_ShowAndGetFile(const char* directory,
                                                           const char* mask,
                                                           const char* heading,
                                                           char& path,
                                                           unsigned int iMaxStringSize,
                                                           ...
                                                           bool singleList)
{
  ...
  bool bRet = CGUIDialogFileBrowser::ShowAndGetFile(directory, mask, heading, strPath, useThumbs,
...
void CAddonCallbacksGUI::Dialog_OK_ShowAndGetInputLineText(const char* heading,
                                                           const char* line0,
                                                           const char* line1,
                                                           const char* line2)
{
...
//@{
bool CAddonCallbacksGUI::Dialog_YesNo_ShowAndGetInputSingleText(const char* heading,
                                                                const char* text,
                                                                bool& bCanceled,
                                                                const char* noLabel,
                                                                const char* yesLabel)
...
bool CAddonCallbacksGUI::Dialog_YesNo_ShowAndGetInputLineText(const char* heading,
                                                              const char* line0,
                                                              const char* line1,
                                                              const char* line2,
                                                              const char* noLabel,
...
bool CAddonCallbacksGUI::Dialog_YesNo_ShowAndGetInputLineButtonText(const char* heading,
                                                                    const char* line0,
                                                                    const char* line1,
                                                                    const char* line2,
                                                                    bool& bCanceled,
...
//@{
int CAddonCallbacksGUI::Dialog_Select(const char* heading,
                                      const char* entries[],
                                      unsigned int size,
                                      int selected)
{
