 ...
 */
  //@{
  void* Interface_GUIWindow::create(void* kodiBase,
                                    ...
                                    bool is_media)
  {
    ...
    if (as_dialog && is_media)
    {
      CLog::Log(LOGWARNING,
                ...
                __FUNCTION__, CAddonInfo::TranslateType(addon->Type()).c_str(),
                addon->Name().c_str(), addon->Author().c_str());
    }
      ...
      if (!XFILE::CFile::Exists(strSkinPath))
      {
        ...
        if (!XFILE::CFile::Exists(strSkinPath))
        {
          CLog::Log(LOGERROR,
                    ...
                    __FUNCTION__, CAddonInfo::TranslateType(addon->Type()).c_str(),
                    addon->Name().c_str(), strSkinPath.c_str(), addon->Author().c_str());
          return nullptr;
        }
      }
    }
    ...
    {
      CLog::Log(LOGERROR,
                "Interface_GUIWindow::%s - Requested window id '%i' does not exist for addon '%s'",
  ...
  void Interface_GUIWindow::destroy(void* kodiBase, void* handle)
  {
    ...
    {
      CLog::Log(LOGERROR,
                "Interface_GUIWindow::%s - invalid handler data (handle='%p') on addon '%s'",
 ...
 */
  ...
  void Interface_GUIWindow::set_control_label(void* kodiBase,
                                              void* handle,
                                              int control_id,
                                              const char* label)
  {
  ...
  void Interface_GUIWindow::set_control_visible(void* kodiBase,
                                                void* handle,
                                                int control_id,
                                                bool visible)
  {
    ...
    Interface_GUIGeneral::lock();
    CGUIMessage msg(visible ? GUI_MSG_VISIBLE : GUI_MSG_HIDDEN, pAddonWindow->m_windowId,
                    control_id);
    pAddonWindow->OnMessage(msg);
    Interface_GUIGeneral::unlock();
  }

  void Interface_GUIWindow::set_control_selected(void* kodiBase,
                                                 void* handle,
                                                 int control_id,
                                                 bool selected)
  {
 ...
 */
  //@{
  void Interface_GUIWindow::set_property(void* kodiBase,
                                         void* handle,
                                         const char* key,
                                         const char* value)
  {
    ...
    if (!addon || !pAddonWindow || !key || !value)
    {
      CLog::Log(LOGERROR,
                ...
                __FUNCTION__, kodiBase, handle, key, value,
  ...
  void Interface_GUIWindow::set_property_int(void* kodiBase,
                                             void* handle,
                                             const char* key,
                                             int value)
  {
  ...
  void Interface_GUIWindow::set_property_bool(void* kodiBase,
                                              void* handle,
                                              const char* key,
                                              bool value)
  {
  ...
  void Interface_GUIWindow::set_property_double(void* kodiBase,
                                                void* handle,
                                                const char* key,
                                                double value)
  {
 ...
 */
  ...
  void Interface_GUIWindow::add_list_item(void* kodiBase,
                                          void* handle,
                                          void* item,
                                          int list_position)
  {
  ...
  void Interface_GUIWindow::remove_list_item_from_position(void* kodiBase,
                                                           void* handle,
                                                           int list_position)
  {
    CAddonDll* addon = static_cast<CAddonDll*>(kodiBase);
  ...
  void* Interface_GUIWindow::get_list_item(void* kodiBase, void* handle, int list_position)
  {
    ...
    {
      CLog::Log(LOGERROR, "ADDON::Interface_GUIWindow - %s: %s - Index out of range", __FUNCTION__,
                addon->Name().c_str());
  ...
  void Interface_GUIWindow::set_current_list_position(void* kodiBase,
                                                      void* handle,
                                                      int list_position)
  {
    CAddonDll* addon = static_cast<CAddonDll*>(kodiBase);
  ...
  void Interface_GUIWindow::set_container_property(void* kodiBase,
                                                   void* handle,
                                                   const char* key,
                                                   const char* value)
  {
 ...
 */
  ...
  {
    return GetControl(kodiBase, handle, control_id, __FUNCTION__, CGUIControl::GUICONTROL_BUTTON,
                      "button");
  }

  void* Interface_GUIWindow::get_control_edit(void* kodiBase, void* handle, int control_id)
  {
    return GetControl(kodiBase, handle, control_id, __FUNCTION__, CGUIControl::GUICONTROL_EDIT,
                      "edit");
  }

  void* Interface_GUIWindow::get_control_fade_label(void* kodiBase, void* handle, int control_id)
  {
    return GetControl(kodiBase, handle, control_id, __FUNCTION__, CGUIControl::GUICONTROL_FADELABEL,
                      "fade label");
  }

  void* Interface_GUIWindow::get_control_image(void* kodiBase, void* handle, int control_id)
  {
    return GetControl(kodiBase, handle, control_id, __FUNCTION__, CGUIControl::GUICONTROL_IMAGE,
                      "image");
  }

  void* Interface_GUIWindow::get_control_label(void* kodiBase, void* handle, int control_id)
  {
    return GetControl(kodiBase, handle, control_id, __FUNCTION__, CGUIControl::GUICONTROL_LABEL,
                      "label");
  }
  void* Interface_GUIWindow::get_control_progress(void* kodiBase, void* handle, int control_id)
  {
    return GetControl(kodiBase, handle, control_id, __FUNCTION__, CGUIControl::GUICONTROL_PROGRESS,
                      "progress");
  }

  void* Interface_GUIWindow::get_control_radio_button(void* kodiBase, void* handle, int control_id)
  {
    return GetControl(kodiBase, handle, control_id, __FUNCTION__, CGUIControl::GUICONTROL_RADIO,
                      "radio button");
  }
  ...
  void* Interface_GUIWindow::get_control_render_addon(void* kodiBase, void* handle, int control_id)
  {
    CGUIControl* pGUIControl =
        static_cast<CGUIControl*>(GetControl(kodiBase, handle, control_id, __FUNCTION__,
  ...
  void* Interface_GUIWindow::get_control_settings_slider(void* kodiBase,
                                                         void* handle,
                                                         int control_id)
  {
    return GetControl(kodiBase, handle, control_id, __FUNCTION__,
  ...
  {
    return GetControl(kodiBase, handle, control_id, __FUNCTION__, CGUIControl::GUICONTROL_SLIDER,
                      "slider");
  }

  void* Interface_GUIWindow::get_control_spin(void* kodiBase, void* handle, int control_id)
  {
    return GetControl(kodiBase, handle, control_id, __FUNCTION__, CGUIControl::GUICONTROL_SPINEX,
                      "spin");
  }

  void* Interface_GUIWindow::get_control_text_box(void* kodiBase, void* handle, int control_id)
  {
    return GetControl(kodiBase, handle, control_id, __FUNCTION__, CGUIControl::GUICONTROL_TEXTBOX,
                      "textbox");
  }
  //@}

  void* Interface_GUIWindow::GetControl(void* kodiBase,
                                        void* handle,
                                        int control_id,
                                        const char* function,
  ...
  int Interface_GUIWindow::GetNextAvailableWindowId()
  {
    ...
    if (CServiceBroker::GetGUI()->GetWindowManager().GetWindow(WINDOW_ADDON_END))
    {
      Interface_GUIGeneral::unlock();
      CLog::Log(LOGERROR,
                "Interface_GUIWindow::%s - Maximum number of windows for binary addons reached",
                __FUNCTION__);
      return -1;
    }
                                                ...
                                                const std::string& typeName)
  {
    ...
    {
      CLog::Log(LOGERROR,
                "CGUIAddonGUI_Window::%s: %s - Requested GUI control Id '%i' for '%s' not present!",
                __FUNCTION__, m_addon->Name().c_str(), controlId, typeName.c_str());
      return nullptr;
    }
    else if (pGUIControl->GetControlType() != type)
    {
      CLog::Log(LOGERROR,
                "CGUIAddonGUI_Window::%s: %s - Requested GUI control Id '%i' not the type '%s'!",
                __FUNCTION__, m_addon->Name().c_str(), controlId, typeName.c_str());
      return nullptr;
    }
  ...
  int CGUIAddonWindow::GetCurrentListPosition() { return m_viewControl.GetSelectedItem(); }

  void CGUIAddonWindow::SetCurrentListPosition(int item) { m_viewControl.SetSelectedItem(item); }

  int CGUIAddonWindow::GetListSize() { return m_vecItems->Size(); }
  ...
  int CGUIAddonWindow::GetCurrentContainerControlId() { return m_viewControl.GetCurrentControl(); }
  ...
  void CGUIAddonWindow::PulseActionEvent() { m_actionEvent.Set(); }

  void CGUIAddonWindow::SetupShares() { UpdateButtons(); }
