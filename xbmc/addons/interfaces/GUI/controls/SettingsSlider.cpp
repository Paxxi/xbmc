...
extern "C"
{
  ...
  void Interface_GUIControlSettingsSlider::set_int_range(void* kodiBase,
                                                         void* handle,
                                                         int start,
                                                         int end)
  {
  ...
  void Interface_GUIControlSettingsSlider::set_int_interval(void* kodiBase,
                                                            void* handle,
                                                            int interval)
  {
    CAddonDll* addon = static_cast<CAddonDll*>(kodiBase);
  ...
  void Interface_GUIControlSettingsSlider::set_percentage(void* kodiBase,
                                                          void* handle,
                                                          float percent)
  {
    CAddonDll* addon = static_cast<CAddonDll*>(kodiBase);
  ...
  void Interface_GUIControlSettingsSlider::set_float_range(void* kodiBase,
                                                           void* handle,
                                                           float start,
                                                           float end)
  {
  ...
  void Interface_GUIControlSettingsSlider::set_float_value(void* kodiBase,
                                                           void* handle,
                                                           float value)
  {
    CAddonDll* addon = static_cast<CAddonDll*>(kodiBase);
  ...
  void Interface_GUIControlSettingsSlider::set_float_interval(void* kodiBase,
                                                              void* handle,
                                                              float interval)
  {
    CAddonDll* addon = static_cast<CAddonDll*>(kodiBase);
