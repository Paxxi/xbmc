...
extern "C"
{
  ...
  void Interface_GUIControlSpin::add_string_label(void* kodiBase,
                                                  void* handle,
                                                  const char* label,
                                                  const char* value)
  {
    ...
    if (!addon || !control || !label || !value)
    {
      CLog::Log(LOGERROR,
                ...
                __FUNCTION__, kodiBase, handle, label, value,
  ...
  void Interface_GUIControlSpin::add_int_label(void* kodiBase,
                                               void* handle,
                                               const char* label,
                                               int value)
  {
  ...
  void Interface_GUIControlSpin::set_float_range(void* kodiBase,
                                                 void* handle,
                                                 float start,
                                                 float end)
  {
