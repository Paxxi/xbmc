...
extern "C"
{
  ...
  {
    addonInterface->toKodi->kodi_gui->listItem =
        static_cast<AddonToKodiFuncTable_kodi_gui_listItem*>(
  ...
  void* Interface_GUIListItem::create(void* kodiBase,
                                      const char* label,
                                      const char* label2,
  ...
  void Interface_GUIListItem::set_art(void* kodiBase,
                                      void* handle,
                                      const char* type,
                                      const char* label)
  {
  ...
  void Interface_GUIListItem::set_property(void* kodiBase,
                                           void* handle,
                                           const char* key,
                                           const char* value)
  {
