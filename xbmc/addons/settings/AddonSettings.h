...
private:
  ...
  std::shared_ptr<CSettingGroup> ParseOldSettingElement(const TiXmlElement* categoryElement,
  ...
  std::shared_ptr<CSetting> InitializeFromOldSettingAction(std::string settingId,
  ...
  bool ParseOldCondition(std::shared_ptr<const CSetting> setting,
  ...
  static void FileEnumSettingOptionsFiller(std::shared_ptr<const CSetting> setting,
