...
extern "C"
{
  ...
  typedef struct KodiToAddonFuncTable_AudioEncoder
  {
    ...
    bool(__cdecl* start)(const AddonInstance_AudioEncoder* instance,
                         int in_channels,
                         int in_rate,
                         int in_bits,
                         const char* title,
                         ...
                         const char* comment,
                         int track_length);
    int(__cdecl* encode)(const AddonInstance_AudioEncoder* instance,
                         int num_bytes_read,
...
private:
  ...
  inline static bool ADDON_Start(const AddonInstance_AudioEncoder* instance,
                                 ...
                                 int trackLength)
  {
    return instance->toAddon.addonInstance->Start(inChannels, inRate, inBits, title, artist,
                                                  albumartist, album, year, track, genre, comment,
                                                  trackLength);
  }
