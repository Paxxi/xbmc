...
extern "C"
{
  ...
  {
    void (*set_callbacks)(void* kodiBase,
                          void* handle,
                          void* clienthandle,
  ...
  {
    bool (*show_and_get_directory)(void* kodiBase,
                                   const char* shares,
                                   const char* heading,
                                   const char* path_in,
                                   char** path_out,
                                   bool writeOnly);
    bool (*show_and_get_file)(void* kodiBase,
                              const char* shares,
                              const char* mask,
                              const char* heading,
                              const char* path_in,
    ...
    bool (*show_and_get_file_from_dir)(void* kodiBase,
                                       ...
                                       bool use_file_directories,
                                       bool singleList);
    bool (*show_and_get_file_list)(void* kodiBase,
                                   const char* shares,
                                   const char* mask,
                                   const char* heading,
                                   char*** file_list,
                                   ...
                                   bool use_thumbs,
                                   bool use_file_directories);
    bool (*show_and_get_source)(void* kodiBase,
                                const char* path_in,
                                char** path_out,
                                bool allow_network_shares,
                                const char* additional_share,
                                const char* type);
    bool (*show_and_get_image)(void* kodiBase,
                               const char* shares,
                               const char* heading,
                               const char* path_in,
                               char** path_out);
    bool (*show_and_get_image_list)(void* kodiBase,
                                    const char* shares,
                                    const char* heading,
                                    char*** file_list,
                                    unsigned int* entries);
  ...
  {
    bool (*show_and_get_input_with_head)(void* kodiBase,
                                         const char* text_in,
                                         char** text_out,
                                         const char* heading,
    ...
    bool (*show_and_get_input)(void* kodiBase,
                               const char* text_in,
                               char** text_out,
                               bool allow_empty_result,
                               unsigned int auto_close_ms);
    bool (*show_and_get_new_password_with_head)(void* kodiBase,
                                                const char* password_in,
                                                char** password_out,
                                                const char* heading,
                                                bool allow_empty_result,
                                                unsigned int auto_close_ms);
    bool (*show_and_get_new_password)(void* kodiBase,
                                      const char* password_in,
                                      char** password_out,
                                      unsigned int auto_close_ms);
    bool (*show_and_verify_new_password_with_head)(void* kodiBase,
                                                   char** password_out,
                                                   const char* heading,
                                                   bool allow_empty_result,
                                                   unsigned int auto_close_ms);
    bool (*show_and_verify_new_password)(void* kodiBase,
                                         char** password_out,
                                         unsigned int auto_close_ms);
    int (*show_and_verify_password)(void* kodiBase,
                                    const char* password_in,
                                    char** password_out,
                                    const char* heading,
                                    int retries,
                                    unsigned int auto_close_ms);
    bool (*show_and_get_filter)(void* kodiBase,
                                const char* text_in,
                                char** text_out,
                                bool searching,
                                unsigned int auto_close_ms);
  ...
  typedef struct AddonToKodiFuncTable_kodi_gui_dialogNumeric
  {
    ...
    int (*show_and_verify_password)(void* kodiBase,
                                    ...
                                    const char* heading,
                                    int retries);
    bool (*show_and_verify_input)(void* kodiBase,
    ...
    bool (*show_and_get_ip_address)(void* kodiBase,
                                    const char* ip_address_in,
                                    char** ip_address_out,
                                    const char* heading);
    bool (*show_and_get_number)(void* kodiBase,
                                const char* input_in,
                                char** input_out,
                                const char* heading,
                                unsigned int auto_close_ms);
    bool (*show_and_get_seconds)(void* kodiBase,
                                 const char* time_in,
                                 char** time_out,
                                 const char* heading);
  ...
  typedef struct AddonToKodiFuncTable_kodi_gui_dialogOK
  {
    ...
    void (*show_and_get_input_line_text)(void* kodiBase,
                                         const char* heading,
                                         const char* line0,
                                         const char* line1,
                                         const char* line2);
  ...
  {
    int (*open)(void* kodiBase,
                const char* heading,
                const char* entries[],
                unsigned int size,
                int selected,
                unsigned int autoclose);
    bool (*open_multi_select)(void* kodiBase,
                              const char* heading,
                              const char* entryIDs[],
  ...
  {
    bool (*show_and_get_input_single_text)(void* kodiBase,
                                           const char* heading,
                                           const char* text,
                                           bool* canceled,
                                           const char* noLabel,
                                           const char* yesLabel);
    bool (*show_and_get_input_line_text)(void* kodiBase,
                                         const char* heading,
                                         const char* line0,
                                         const char* line1,
                                         const char* line2,
                                         const char* noLabel,
                                         const char* yesLabel);
    bool (*show_and_get_input_line_button_text)(void* kodiBase,
                                                const char* heading,
                                                const char* line0,
                                                const char* line1,
                                                const char* line2,
...
#define ADDON_MAX_CONTEXT_ENTRY_NAME_LENGTH 80
  ...
  typedef struct AddonToKodiFuncTable_kodi_gui_window
  {
    ...
    void (*set_container_property)(void* kodiBase,
                                   void* handle,
                                   const char* key,
                                   const char* value);
    ...
    void* (*get_control_dummy10)(
        void* kodiBase,
        void* handle,
        int control_id); /* This and above used to add new get_control_* functions */
