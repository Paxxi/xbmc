...
/// ~~~~~~~~~~~~~
///
inline bool ShowAndGetDirectory(const std::string& shares,
...
/// @return                         False if selection becomes canceled.
///
inline bool ShowAndGetFile(const std::string& shares,
...
/// @return                         False if selection becomes canceled.
///
inline bool ShowAndGetFileFromDir(const std::string& directory,
                                  const std::string& mask,
                                  const std::string& heading,
                                  std::string& path,
                                  bool useThumbs = false,
...
/// @return False if selection becomes canceled.
///
inline bool ShowAndGetFileList(const std::string& shares,
                               const std::string& mask,
                               const std::string& heading,
...
/// @return                       False if selection becomes canceled.
///
inline bool ShowAndGetSource(std::string& path,
...
/// @return               False if selection becomes canceled.
///
inline bool ShowAndGetImage(const std::string& shares,
                            const std::string& heading,
                            std::string& path)
{
  using namespace ::kodi::addon;
...
/// @return                 False if selection becomes canceled.
///
inline bool ShowAndGetImageList(const std::string& shares,
                                const std::string& heading,
