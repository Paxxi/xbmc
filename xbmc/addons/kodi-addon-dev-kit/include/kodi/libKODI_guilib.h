...
typedef struct CB_GUILib
{
  ...
  void (*Window_SetCallbacks)(void* addonData,
                              GUIHANDLE handle,
  ...
  void (*Window_SetPropertyDouble)(void* addonData,
                                   GUIHANDLE handle,
                                   const char* key,
                                   double value);
  ...
  GUIHANDLE (*Window_AddStringItem)
  (void* addonData, GUIHANDLE handle, const char* itemName, int itemPosition);
  ...
  void (*Window_SetControlLabel)(void* addonData,
                                 GUIHANDLE handle,
                                 int controlId,
                                 const char* label);
  ...
  void (*Control_Spin_AddLabel)(void* addonData,
  ...
  void (*Control_SettingsSlider_SetIntRange)(void* addonData,
                                             GUIHANDLE handle,
                                             int iStart,
                                             int iEnd);
  ...
  void (*Control_SettingsSlider_SetFloatRange)(void* addonData,
                                               GUIHANDLE handle,
                                               float fStart,
                                               float fEnd);
  ...
  void (*Control_SettingsSlider_SetFloatInterval)(void* addonData,
                                                  GUIHANDLE handle,
                                                  float fInterval);
  ...
  void (*ListItem_SetProperty)(void* addonData,
                               GUIHANDLE handle,
                               const char* key,
                               const char* value);
  ...
  void (*RenderAddon_SetCallbacks)(void* addonData,
                                   GUIHANDLE handle,
                                   GUIHANDLE clienthandle,
  ...
  bool (*Dialog_Keyboard_ShowAndGetInputWithHead)(char& strTextString,
                                                  unsigned int iMaxStringSize,
                                                  const char* heading,
                                                  bool allowEmptyResult,
                                                  bool hiddenInput,
                                                  unsigned int autoCloseMs);
  bool (*Dialog_Keyboard_ShowAndGetInput)(char& strTextString,
                                          unsigned int iMaxStringSize,
                                          bool allowEmptyResult,
                                          unsigned int autoCloseMs);
  bool (*Dialog_Keyboard_ShowAndGetNewPasswordWithHead)(char& newPassword,
                                                        unsigned int iMaxStringSize,
                                                        const char* strHeading,
                                                        bool allowEmptyResult,
                                                        unsigned int autoCloseMs);
  bool (*Dialog_Keyboard_ShowAndGetNewPassword)(char& strNewPassword,
                                                unsigned int iMaxStringSize,
                                                unsigned int autoCloseMs);
  bool (*Dialog_Keyboard_ShowAndVerifyNewPasswordWithHead)(char& strNewPassword,
                                                           unsigned int iMaxStringSize,
                                                           const char* strHeading,
                                                           bool allowEmpty,
                                                           unsigned int autoCloseMs);
  bool (*Dialog_Keyboard_ShowAndVerifyNewPassword)(char& strNewPassword,
                                                   unsigned int iMaxStringSize,
                                                   unsigned int autoCloseMs);
  int (*Dialog_Keyboard_ShowAndVerifyPassword)(char& strPassword,
                                               unsigned int iMaxStringSize,
                                               const char* strHeading,
                                               int iRetries,
                                               unsigned int autoCloseMs);
  bool (*Dialog_Keyboard_ShowAndGetFilter)(char& aTextString,
                                           unsigned int iMaxStringSize,
                                           bool searching,
                                           unsigned int autoCloseMs);
  ...
  bool (*Dialog_Numeric_ShowAndVerifyNewPassword)(char& strNewPassword,
                                                  unsigned int iMaxStringSize);
  int (*Dialog_Numeric_ShowAndVerifyPassword)(char& strPassword,
                                              unsigned int iMaxStringSize,
                                              const char* strHeading,
                                              int iRetries);
  bool (*Dialog_Numeric_ShowAndVerifyInput)(char& strPassword,
                                            unsigned int iMaxStringSize,
                                            const char* strHeading,
                                            bool bGetUserInput);
  ...
  bool (*Dialog_Numeric_ShowAndGetIPAddress)(char& strIPAddress,
                                             unsigned int iMaxStringSize,
                                             const char* strHeading);
  bool (*Dialog_Numeric_ShowAndGetNumber)(char& strInput,
                                          unsigned int iMaxStringSize,
                                          const char* strHeading,
                                          unsigned int iAutoCloseTimeoutMs);
  bool (*Dialog_Numeric_ShowAndGetSeconds)(char& timeString,
                                           unsigned int iMaxStringSize,
                                           const char* strHeading);

  bool (*Dialog_FileBrowser_ShowAndGetFile)(const char* directory,
                                            const char* mask,
                                            const char* heading,
                                            char& path,
                                            unsigned int iMaxStringSize,
  ...
  void (*Dialog_OK_ShowAndGetInputLineText)(const char* heading,
                                            const char* line0,
                                            const char* line1,
                                            const char* line2);

  bool (*Dialog_YesNo_ShowAndGetInputSingleText)(const char* heading,
                                                 const char* text,
                                                 bool& bCanceled,
                                                 const char* noLabel,
                                                 const char* yesLabel);
  bool (*Dialog_YesNo_ShowAndGetInputLineText)(const char* heading,
                                               const char* line0,
                                               const char* line1,
                                               const char* line2,
                                               const char* noLabel,
                                               const char* yesLabel);
  bool (*Dialog_YesNo_ShowAndGetInputLineButtonText)(const char* heading,
                                                     const char* line0,
                                                     const char* line1,
                                                     const char* line2,
                                                     bool& bCanceled,
...
public:
  ...
  {
    m_controlHandle =
        m_cb->ListItem_Create(m_Handle->addonData, label, label2, iconImage, thumbnailImage, path);
  }
...
public:
    ...
    , CBOnAction(nullptr)
  {
    ...
    {
      m_controlHandle =
          m_cb->Window_New(m_Handle->addonData, xmlFilename, defaultSkin, forceFallback, asDialog);
      if (!m_controlHandle)
        fprintf(stderr, "libKODI_guilib: ERROR: Can't create window class !!!\n");

      m_cb->Window_SetCallbacks(m_Handle->addonData, m_controlHandle, this, OnInitCB, OnClickCB,
                                OnFocusCB, OnActionCB);
    }
  }
  ...
  bool Show() { return m_cb->Window_Show(m_Handle->addonData, m_controlHandle); }

  void Close() { m_cb->Window_Close(m_Handle->addonData, m_controlHandle); }

  void DoModal() { m_cb->Window_DoModal(m_Handle->addonData, m_controlHandle); }
  ...
  int GetFocusId() { return m_cb->Window_GetFocusId(m_Handle->addonData, m_controlHandle); }
  ...
  void ClearProperties() { m_cb->Window_ClearProperties(m_Handle->addonData, m_controlHandle); }

  int GetListSize() { return m_cb->Window_GetListSize(m_Handle->addonData, m_controlHandle); }

  void ClearList() { m_cb->Window_ClearList(m_Handle->addonData, m_controlHandle); }
  ...
  {
    m_cb->Window_AddItem(m_Handle->addonData, m_controlHandle, item->GetControlHandle(),
                         itemPosition);
  }
  ...
  void MarkDirtyRegion() { m_cb->Window_MarkDirtyRegion(m_Handle->addonData, m_controlHandle); }
...
{
public:
  CAddonGUISpinControl(AddonCB* hdl,
                       KodiAPI::GUI::CB_GUILib* cb,
  ...
  {
    m_controlHandle =
        m_cb->Window_GetControl_Spin(m_Handle->addonData, m_Window->GetControlHandle(), controlId);
  }
...
{
public:
  CAddonGUIRadioButton(AddonCB* hdl,
                       KodiAPI::GUI::CB_GUILib* cb,
                       CAddonGUIWindow* window,
                       int controlId)
    : CAddonGUIControlBase(hdl, cb, window)
  {
    m_controlHandle = m_cb->Window_GetControl_RadioButton(m_Handle->addonData,
...
{
public:
  CAddonGUIProgressControl(AddonCB* hdl,
                           KodiAPI::GUI::CB_GUILib* cb,
                           CAddonGUIWindow* window,
                           int controlId)
    : CAddonGUIControlBase(hdl, cb, window)
  {
    m_controlHandle = m_cb->Window_GetControl_Progress(m_Handle->addonData,
                                                       m_Window->GetControlHandle(), controlId);
  }
...
{
public:
  CAddonGUISliderControl(AddonCB* hdl,
                         KodiAPI::GUI::CB_GUILib* cb,
                         CAddonGUIWindow* window,
                         int controlId)
    : CAddonGUIControlBase(hdl, cb, window)
  {
    m_controlHandle = m_cb->Window_GetControl_Slider(m_Handle->addonData,
                                                     m_Window->GetControlHandle(), controlId);
  }
...
{
public:
  CAddonGUISettingsSliderControl(AddonCB* hdl,
                                 KodiAPI::GUI::CB_GUILib* cb,
                                 CAddonGUIWindow* window,
                                 int controlId)
    : CAddonGUIControlBase(hdl, cb, window)
  {
    m_controlHandle = m_cb->Window_GetControl_SettingsSlider(
        m_Handle->addonData, m_Window->GetControlHandle(), controlId);
  }
  ...
  {
    if (m_controlHandle)
      m_cb->Control_SettingsSlider_SetFloatRange(m_Handle->addonData, m_controlHandle, fStart,
                                                 fEnd);
  }
  ...
  {
    if (m_controlHandle)
      m_cb->Control_SettingsSlider_SetFloatInterval(m_Handle->addonData, m_controlHandle,
                                                    fInterval);
  }
};
...
{
public:
  CAddonGUIRenderingControl(AddonCB* hdl,
                            KodiAPI::GUI::CB_GUILib* cb,
                            CAddonGUIWindow* window,
                            int controlId)
    : CAddonGUIControlBase(hdl, cb, window)
    ...
    , CBDirty(nullptr)
  {
    m_controlHandle = m_cb->Window_GetControl_RenderAddon(m_Handle->addonData,
                                                          m_Window->GetControlHandle(), controlId);
  }
  ...
  void Init()
  {
    m_cb->RenderAddon_SetCallbacks(m_Handle->addonData, m_controlHandle, this, OnCreateCB,
...
inline bool CAddonGUIRenderingControl::OnCreateCB(
    GUIHANDLE cbhdl, int x, int y, int w, int h, void* device)
{
...
public:
  ...
  bool RegisterMe(void* handle)
  {
    ...
    if (!m_Callbacks)
      fprintf(stderr,
              "libKODI_guilib-ERROR: GUILib_RegisterMe can't get callback table from Kodi !!!\n");

    return m_Callbacks != nullptr;
  }

  void Lock() { m_Callbacks->Lock(); }

  void Unlock() { m_Callbacks->Unlock(); }

  int GetScreenHeight() { return m_Callbacks->GetScreenHeight(); }

  int GetScreenWidth() { return m_Callbacks->GetScreenWidth(); }

  int GetVideoResolution() { return m_Callbacks->GetVideoResolution(); }

  CAddonGUIWindow* Window_create(const char* xmlFilename,
                                 const char* defaultSkin,
                                 bool forceFallback,
                                 bool asDialog)
  {
    return new CAddonGUIWindow(m_Handle, m_Callbacks, xmlFilename, defaultSkin, forceFallback,
                               asDialog);
  }

  void Window_destroy(CAddonGUIWindow* p) { delete p; }
  ...
  void Control_releaseSpin(CAddonGUISpinControl* p) { delete p; }
  ...
  void Control_releaseRadioButton(CAddonGUIRadioButton* p) { delete p; }
  ...
  void Control_releaseProgress(CAddonGUIProgressControl* p) { delete p; }

  CAddonListItem* ListItem_create(const char* label,
                                  const char* label2,
                                  const char* iconImage,
                                  const char* thumbnailImage,
                                  const char* path)
  {
    return new CAddonListItem(m_Handle, m_Callbacks, label, label2, iconImage, thumbnailImage,
                              path);
  }

  void ListItem_destroy(CAddonListItem* p) { delete p; }
  ...
  void Control_releaseRendering(CAddonGUIRenderingControl* p) { delete p; }
  ...
  void Control_releaseSlider(CAddonGUISliderControl* p) { delete p; }
  ...
  void Control_releaseSettingsSlider(CAddonGUISettingsSliderControl* p) { delete p; }

  /*! @name GUI Keyboard functions */
  //@{
  bool Dialog_Keyboard_ShowAndGetInput(char& strText,
                                       unsigned int iMaxStringSize,
                                       const char* strHeading,
                                       bool allowEmptyResult,
                                       bool hiddenInput,
  ...
  {
    return m_Callbacks->Dialog_Keyboard_ShowAndGetInputWithHead(
        strText, iMaxStringSize, strHeading, allowEmptyResult, hiddenInput, autoCloseMs);
  }
  ...
  bool Dialog_Keyboard_ShowAndGetInput(char& strText,
                                       ...
                                       unsigned int autoCloseMs = 0)
  {
    return m_Callbacks->Dialog_Keyboard_ShowAndGetInput(strText, iMaxStringSize, allowEmptyResult,
                                                        autoCloseMs);
  }
  ...
  bool Dialog_Keyboard_ShowAndGetNewPassword(char& strNewPassword,
                                             ...
                                             unsigned int autoCloseMs = 0)
  {
    return m_Callbacks->Dialog_Keyboard_ShowAndGetNewPasswordWithHead(
        strNewPassword, iMaxStringSize, strHeading, allowEmptyResult, autoCloseMs);
  }
  ...
  bool Dialog_Keyboard_ShowAndGetNewPassword(char& strNewPassword,
                                             ...
                                             unsigned int autoCloseMs = 0)
  {
    return m_Callbacks->Dialog_Keyboard_ShowAndGetNewPassword(strNewPassword, iMaxStringSize,
                                                              autoCloseMs);
  }
  ...
  bool Dialog_Keyboard_ShowAndVerifyNewPassword(char& strNewPassword,
                                                ...
                                                unsigned int autoCloseMs = 0)
  {
    return m_Callbacks->Dialog_Keyboard_ShowAndVerifyNewPasswordWithHead(
        strNewPassword, iMaxStringSize, strHeading, allowEmptyResult, autoCloseMs);
  }
  ...
  bool Dialog_Keyboard_ShowAndVerifyNewPassword(char& strNewPassword,
                                                ...
                                                unsigned int autoCloseMs = 0)
  {
    return m_Callbacks->Dialog_Keyboard_ShowAndVerifyNewPassword(strNewPassword, iMaxStringSize,
                                                                 autoCloseMs);
  }
  ...
  int Dialog_Keyboard_ShowAndVerifyPassword(char& strPassword,
                                            ...
                                            unsigned int autoCloseMs = 0)
  {
    return m_Callbacks->Dialog_Keyboard_ShowAndVerifyPassword(strPassword, iMaxStringSize,
                                                              strHeading, iRetries, autoCloseMs);
  }

  bool Dialog_Keyboard_ShowAndGetFilter(char& strText,
                                        unsigned int iMaxStringSize,
                                        bool searching,
                                        unsigned int autoCloseMs = 0)
  {
    return m_Callbacks->Dialog_Keyboard_ShowAndGetFilter(strText, iMaxStringSize, searching,
                                                         autoCloseMs);
  }
  ...
  int Dialog_Numeric_ShowAndVerifyPassword(char& strPassword,
                                           ...
                                           int iRetries)
  {
    return m_Callbacks->Dialog_Numeric_ShowAndVerifyPassword(strPassword, iMaxStringSize,
                                                             strHeading, iRetries);
  }
  ...
  bool Dialog_Numeric_ShowAndVerifyInput(char& strPassword,
                                         ...
                                         bool bGetUserInput)
  {
    return m_Callbacks->Dialog_Numeric_ShowAndVerifyInput(strPassword, iMaxStringSize, strHeading,
                                                          bGetUserInput);
  }
  ...
  bool Dialog_Numeric_ShowAndGetIPAddress(char& strIPAddress,
                                          ...
                                          const char* strHeading)
  {
    return m_Callbacks->Dialog_Numeric_ShowAndGetIPAddress(strIPAddress, iMaxStringSize,
                                                           strHeading);
  }
  ...
  {
    return m_Callbacks->Dialog_Numeric_ShowAndGetNumber(strInput, iMaxStringSize, strHeading,
                                                        iAutoCloseTimeoutMs);
  }

  bool Dialog_Numeric_ShowAndGetSeconds(char& strTime,
                                        unsigned int iMaxStringSize,
                                        const char* strHeading)
  {
  ...
  {
    return m_Callbacks->Dialog_FileBrowser_ShowAndGetFile(directory, mask, heading, strPath,
                                                          iMaxStringSize, useThumbs,
  ...
  void Dialog_OK_ShowAndGetInput(const char* heading,
                                 const char* line0,
                                 const char* line1,
                                 const char* line2)
  {
  ...
  //@{
  bool Dialog_YesNo_ShowAndGetInput(const char* heading,
                                    const char* text,
                                    bool& bCanceled,
                                    const char* noLabel = "",
                                    const char* yesLabel = "")
  {
    return m_Callbacks->Dialog_YesNo_ShowAndGetInputSingleText(heading, text, bCanceled, noLabel,
                                                               yesLabel);
  }
  ...
  bool Dialog_YesNo_ShowAndGetInput(const char* heading,
                                    ...
                                    const char* yesLabel = "")
  {
    return m_Callbacks->Dialog_YesNo_ShowAndGetInputLineText(heading, line0, line1, line2, noLabel,
                                                             yesLabel);
  }
  ...
  bool Dialog_YesNo_ShowAndGetInput(const char* heading,
                                    ...
                                    const char* yesLabel = "")
  {
    return m_Callbacks->Dialog_YesNo_ShowAndGetInputLineButtonText(heading, line0, line1, line2,
                                                                   bCanceled, noLabel, yesLabel);
  }
  //@}
  ...
  //@{
  int Dialog_Select(const char* heading,
                    const char* entries[],
                    unsigned int size,
                    int selected = -1)
  {
