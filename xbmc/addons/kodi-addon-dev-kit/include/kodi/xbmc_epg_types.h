...
extern "C"
{
  ...
  const unsigned int EPG_TAG_FLAG_UNDEFINED =
      0x00000000; /*!< @brief nothing special to say about this entry */
  const unsigned int EPG_TAG_FLAG_IS_SERIES =
      0x00000001; /*!< @brief this EPG entry is part of a series */
  ...
  {
    unsigned int
        iUniqueBroadcastId; /*!< @brief (required) identifier for this event. Event uids must be unique for a channel. Valid uids must be greater than EPG_TAG_INVALID_UID. */
    unsigned int
        iUniqueChannelId; /*!< @brief (required) unique identifier of the channel this event belongs to. */
    ...
    const char*
        strCast; /*!< @brief (optional) cast. Use EPG_STRING_TOKEN_SEPARATOR to separate different persons. */
    const char*
        strDirector; /*!< @brief (optional) director(s). Use EPG_STRING_TOKEN_SEPARATOR to separate different persons. */
    const char*
        strWriter; /*!< @brief (optional) writer(s). Use EPG_STRING_TOKEN_SEPARATOR to separate different persons. */
    ...
    const char*
        strGenreDescription; /*!< @brief (optional) genre. Will be used only when iGenreType == EPG_GENRE_USE_STRING or iGenreSubType == EPG_GENRE_USE_STRING. Use EPG_STRING_TOKEN_SEPARATOR to separate different genres. */
    ...
    unsigned int
        iFlags; /*!< @brief (optional) bit field of independent flags associated with the EPG entry */
