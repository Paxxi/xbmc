...
#ifdef TARGET_POSIX
  if (strstr(sName, ".so") != nullptr || strstr(sName, ".vis") != nullptr || strstr(sName, ".xbs") != nullptr
      || strstr(sName, ".mvis") != nullptr || strstr(sName, ".dylib") != nullptr || strstr(sName, ".framework") != nullptr || strstr(sName, ".pvr") != nullptr)
