...
Export win32_exports[] = {
  {"LoadLibraryA", static_cast<unsigned long>(-1), (void*)dllLoadLibraryA,
   (void*)track_LoadLibraryA},
  {"FreeLibrary", static_cast<unsigned long>(-1), (void*)dllFreeLibrary, (void*)track_FreeLibrary},
  // msvcrt
  {"_close", static_cast<unsigned long>(-1), (void*)dll_close, (void*)track_close},
  {"_lseek", static_cast<unsigned long>(-1), (void*)dll_lseek, NULL},
  {"_read", static_cast<unsigned long>(-1), (void*)dll_read, NULL},
  {"_write", static_cast<unsigned long>(-1), (void*)dll_write, NULL},
  {"_lseeki64", static_cast<unsigned long>(-1), (void*)dll_lseeki64, NULL},
  {"_open", static_cast<unsigned long>(-1), (void*)dll_open, (void*)track_open},
  {"fflush", static_cast<unsigned long>(-1), (void*)dll_fflush, NULL},
  {"fprintf", static_cast<unsigned long>(-1), (void*)dll_fprintf, NULL},
  {"fwrite", static_cast<unsigned long>(-1), (void*)dll_fwrite, NULL},
  {"putchar", static_cast<unsigned long>(-1), (void*)dll_putchar, NULL},
  {"_fstat", static_cast<unsigned long>(-1), (void*)dll_fstat, NULL},
  {"_mkdir", static_cast<unsigned long>(-1), (void*)dll_mkdir, NULL},
  {"_stat", static_cast<unsigned long>(-1), (void*)dll_stat, NULL},
  {"_fstat32", static_cast<unsigned long>(-1), (void*)dll_fstat, NULL},
  {"_stat32", static_cast<unsigned long>(-1), (void*)dll_stat, NULL},
  {"_findclose", static_cast<unsigned long>(-1), (void*)dll_findclose, NULL},
  {"_findfirst", static_cast<unsigned long>(-1), (void*)dll_findfirst, NULL},
  {"_findnext", static_cast<unsigned long>(-1), (void*)dll_findnext, NULL},
  {"_findfirst64i32", static_cast<unsigned long>(-1), (void*)dll_findfirst64i32, NULL},
  {"_findnext64i32", static_cast<unsigned long>(-1), (void*)dll_findnext64i32, NULL},
  {"fclose", static_cast<unsigned long>(-1), (void*)dll_fclose, (void*)track_fclose},
  {"feof", static_cast<unsigned long>(-1), (void*)dll_feof, NULL},
  {"fgets", static_cast<unsigned long>(-1), (void*)dll_fgets, NULL},
  {"fopen", static_cast<unsigned long>(-1), (void*)dll_fopen, (void*)track_fopen},
  {"fopen_s", static_cast<unsigned long>(-1), (void*)dll_fopen_s, NULL},
  {"putc", static_cast<unsigned long>(-1), (void*)dll_putc, NULL},
  {"fputc", static_cast<unsigned long>(-1), (void*)dll_fputc, NULL},
  {"fputs", static_cast<unsigned long>(-1), (void*)dll_fputs, NULL},
  {"fread", static_cast<unsigned long>(-1), (void*)dll_fread, NULL},
  {"fseek", static_cast<unsigned long>(-1), (void*)dll_fseek, NULL},
  {"ftell", static_cast<unsigned long>(-1), (void*)dll_ftell, NULL},
  {"getc", static_cast<unsigned long>(-1), (void*)dll_getc, NULL},
  {"fgetc", static_cast<unsigned long>(-1), (void*)dll_getc, NULL},
  {"rewind", static_cast<unsigned long>(-1), (void*)dll_rewind, NULL},
  {"vfprintf", static_cast<unsigned long>(-1), (void*)dll_vfprintf, NULL},
  {"fgetpos", static_cast<unsigned long>(-1), (void*)dll_fgetpos, NULL},
  {"fsetpos", static_cast<unsigned long>(-1), (void*)dll_fsetpos, NULL},
  {"_stati64", static_cast<unsigned long>(-1), (void*)dll_stati64, NULL},
  {"_stat64", static_cast<unsigned long>(-1), (void*)dll_stat64, NULL},
  {"_stat64i32", static_cast<unsigned long>(-1), (void*)dll_stat64i32, NULL},
  {"_fstati64", static_cast<unsigned long>(-1), (void*)dll_fstati64, NULL},
  {"_fstat64", static_cast<unsigned long>(-1), (void*)dll_fstat64, NULL},
  {"_fstat64i32", static_cast<unsigned long>(-1), (void*)dll_fstat64i32, NULL},
  {"_telli64", static_cast<unsigned long>(-1), (void*)dll_telli64, NULL},
  {"_tell", static_cast<unsigned long>(-1), (void*)dll_tell, NULL},
  {"_fileno", static_cast<unsigned long>(-1), (void*)dll_fileno, NULL},
  {"ferror", static_cast<unsigned long>(-1), (void*)dll_ferror, NULL},
  {"freopen", static_cast<unsigned long>(-1), (void*)dll_freopen, (void*)track_freopen},
  {"fscanf", static_cast<unsigned long>(-1), (void*)dll_fscanf, NULL},
  {"ungetc", static_cast<unsigned long>(-1), (void*)dll_ungetc, NULL},
  {"_fdopen", static_cast<unsigned long>(-1), (void*)dll_fdopen, NULL},
  {"clearerr", static_cast<unsigned long>(-1), (void*)dll_clearerr, NULL},
  // for debugging
  {"printf", static_cast<unsigned long>(-1), (void*)dllprintf, NULL},
  {"vprintf", static_cast<unsigned long>(-1), (void*)dllvprintf, NULL},
  {"perror", static_cast<unsigned long>(-1), (void*)dllperror, NULL},
  {"puts", static_cast<unsigned long>(-1), (void*)dllputs, NULL},
  // workarounds for non-win32 signals
  {"signal", static_cast<unsigned long>(-1), (void*)dll_signal, NULL},

  // libdvdnav + python need this (due to us using dll_putenv() to put stuff only?)
  {"getenv", static_cast<unsigned long>(-1), (void*)dll_getenv, NULL},
  ...
  Win32DllLoader::Win32DllLoader(const std::string& dll, bool isSystemDll) : LibraryLoader(dll),
  bIsSystemDll(isSystemDll){m_dllHandle = NULL;
