...
{
  char fourCC[5] = {(char)((desc.mFormatID >> 24) & 0xFF), (char)((desc.mFormatID >> 16) & 0xFF),
                    (char)((desc.mFormatID >> 8) & 0xFF), (char)(desc.mFormatID & 0xFF), 0};
  ...
  case kAudioFormatLinearPCM:
    sstr << "[" << fourCC << "] "
         ...
         << ((desc.mFormatFlags & kAudioFormatFlagIsNonInterleaved) ? "Non-" : "") << "Interleaved "
         << desc.mChannelsPerFrame << " Channel " << desc.mBitsPerChannel << "-bit "
