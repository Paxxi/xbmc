...
void CYUV2RGBShader::SetShaderParameters(CRenderBuffer* videoBuffer)
{
  ...
  if (m_pConvMatrix->GetPrimMat(primMat))
  {
    ...
    float dxMat[4][4] = {};
    dxMat[0][0] = primMat[0][0];
    dxMat[0][1] = primMat[0][1];
    dxMat[0][2] = primMat[0][2];
    dxMat[1][0] = primMat[1][0];
    dxMat[1][1] = primMat[1][1];
    dxMat[1][2] = primMat[1][2];
    dxMat[2][0] = primMat[2][0];
    dxMat[2][1] = primMat[2][1];
    dxMat[2][2] = primMat[2][2];
