...
#define OC_OVERLAY \
  0x00000004 // the decoder decoded an overlay, call Decode(NULL, 0) again to parse the rest of the data
...
{
public:
  explicit CDVDOverlayCodec(const char* name)
    : m_codecName(name)
  {
  }
...
protected:
   ...
   */
  static void GetAbsoluteTimes(
      double& starttime, double& stoptime, DemuxPacket* pkt, bool& replace, double offset = 0.0);
