...
private:
  ...
  static bool CompileRegExp(const std::string& str, KODI::UTILS::TEXT::CRegExp& regExp);
  static bool MatchesRegExp(const std::string& str, KODI::UTILS::TEXT::CRegExp& regExp);
