...
const CWindowTranslator::WindowMapByName CWindowTranslator::WindowMappingByName = {
    ...
    {"fullscreenlivetv",
     WINDOW_FULLSCREEN_LIVETV}, // virtual window for fullscreen radio, uses WINDOW_FULLSCREEN_VIDEO as fallback
    ...
    {"fullscreenradio",
     WINDOW_FULLSCREEN_RADIO}, // virtual window for fullscreen radio, uses WINDOW_VISUALISATION as fallback
